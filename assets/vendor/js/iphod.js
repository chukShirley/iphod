...
var _user$project$Iphod$main = _elm_lang$html$Html$program(
...
var Elm = {};
Elm['Iphod'] = Elm['Iphod'] || {};
if (typeof _user$project$Iphod$main !== 'undefined') {
    _user$project$Iphod$main(Elm['Iphod'], 'Iphod', undefined);
}
