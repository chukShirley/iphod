...
var _user$project$Iphod_Models$initPsalms = {
	mp: {ctor: '[]'},
	ep: {ctor: '[]'}
};
...
var _user$project$Iphod_Models$Psalms = F2(
	function (a, b) {
		return {mp: a, ep: b};
	});
					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {eu: a, daily: b, psalms: c, date: d, monthDay: e, season: f, week: g, colors: h, rld: i, title: j};
									};
								};
							};
						};
...
var _user$project$MIndex$psalmDiv = function (vss) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('psalm'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$MIndex$lesson3Div = function (vss) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('lesson3'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$MIndex$lesson2Div = function (vss) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('lesson2'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$MIndex$lesson1Div = function (vss) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('lesson1'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$MIndex$calendarDays = function (days) {
...
var _user$project$MIndex$calendarTable = function (model) {
	var calendarWeeks = function (week) {
		return _user$project$MIndex$calendarDays(week.days);
	};
	return A2(
...
var _user$project$MIndex$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$MIndex$calendarTable(model),
			_1: {
				ctor: '::',
				_0: _user$project$MIndex$lesson1Div(model.lesson1),
				_1: {
					ctor: '::',
					_0: _user$project$MIndex$psalmDiv(model.psalm),
					_1: {
						ctor: '::',
						_0: _user$project$MIndex$lesson2Div(model.lesson2),
						_1: {
							ctor: '::',
							_0: _user$project$MIndex$lesson3Div(model.lesson3),
							_1: {
								ctor: '::',
								_0: _user$project$MIndex$reflectionDiv(model.reflection),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$MIndex$initModel = {month: _user$project$Iphod_Models$initMonth, reflection: _user$project$Iphod_Models$initReflection, lesson1: '', lesson2: '', lesson3: '', psalm: ''};
...
var _user$project$MIndex$requestScrollTop = _elm_lang$core$Native_Platform.outgoingPort(
	'requestScrollTop',
	function (v) {
		return v;
	});
var _user$project$MIndex$portMonth = _elm_lang$core$Native_Platform.incomingPort(
	'portMonth',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (weeks) {
																							...
																							return A2(
																								...
																								function (rld) {
																									return A2(
																										...
																										function (title) {
																											return _elm_lang$core$Json_Decode$succeed(
																												{eu: eu, daily: daily, psalms: psalms, date: date, monthDay: monthDay, season: season, week: week, colors: colors, rld: rld, title: title});
																										},
...
var _user$project$MIndex$Model = F6(
	function (a, b, c, d, e, f) {
		return {month: a, lesson1: b, lesson2: c, lesson3: d, psalm: e, reflection: f};
	});
var _user$project$MIndex$Hide = {ctor: 'Hide'};
var _user$project$MIndex$Show = {ctor: 'Show'};
...
var _user$project$MIndex$InitMonth = function (a) {
...
var _user$project$MIndex$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$MIndex$portMonth(_user$project$MIndex$InitMonth),
			_1: {
				ctor: '::',
...
if (typeof _user$project$MIndex$main !== 'undefined') {
    _user$project$MIndex$main(Elm['MIndex'], 'MIndex', undefined);
}
