    ...
    %{ "advent" =>
      %{"1" =>
        %{"Sunday" => %{title: "First Sunday in Advent",
            ...
            "Friday" =>     %{ title: "Friday",
                              mp1: [%{style: "req", read: "Isa 14.3-27"},%{style: "opt", read: "Isa 14.28 through 15.9"}],
        ...
        "2" =>
          %{"Sunday" =>   %{title: "Second Sunday in Advent",
            ...
            "Thursday" => %{title: "Thursday",
                            mp1: [%{style: "req", read: "Isa 29.15 through 30.18"},%{style: "opt", read: "Isa 30.19 through 31.9"}],
        ...
        "3" =>
          %{"Sunday" =>     %{title: "Third Sunday in Advent",
            ...
            "Monday" =>     %{title: "Monday",
                              ...
                              ep1: [%{style: "req", read: "Isa 42.18 through 43.13"}],
                              ep2: [%{style: "req", read: "Rev 18"}] },
            "Tuesday" =>    %{title: "Tuesday",
                              mp1: [%{style: "req", read: "Isa 43.14 through 44.5"}],
                              mp2: [%{style: "req", read: "Mark 7.24 through 8.10"}],
                              ep1: [%{style: "req", read: "Isa 44.6-23"}],
                              ep2: [%{style: "req", read: "Rev 19"}] },
            "Wednesday" =>  %{title: "Wednesday Ember Day",
                              mp1: [%{style: "req", read: "Isa 44.24 through 45.13"}],
                              mp2: [%{style: "req", read: "Mark 8.11 through 9.1"}],
        ...
        "4" =>
          %{"Sunday" =>     %{title: "Fourth Sunday in Advent",
            ...
            "Monday" =>     %{title: "Monday",
                              ...
                              ep1: [%{style: "req", read: "Isa 51.17 through 52.12"}],
                              ep2: [%{style: "req", read: "Jude 1-16"}] },
            "Tuesday" =>    %{title: "Tuesday",
                              mp1: [%{style: "req", read: "Isa 52.13 through 53"}],
            ...
            "Wednesday" =>  %{title: "Wednesday",
                              ...
                              mp2: [%{style: "req", read: "Mark 11.27 through 12.12"}],
            ...
            "Friday" =>     %{title: "Friday",
                              ...
                              mp2: [%{style: "req", read: "Mark 12.35 through 13.13"}],
        ...
        %{
          ...
          %{"Sunday" =>   %{title: "Eighth Sunday of Epiphany",
            ...
            "Monday" =>   %{title: "Monday",
                            ...
                            mp2: [%{style: "req", read: "Matt 19.16 through 20.16"}],
        ...
        %{"2" =>
          ...
          %{"Sunday" =>   %{title: "Fourth Sunday of Easter",
            ...
            "Tuesday" =>  %{title: "Tuesday",
                            ...
                            mp2: [%{style: "req", read: "Acts 15.36 through 16.5"}],
            ...
            "Thursday" => %{title: "Thursday",
                            ...
                            ep2: [%{style: "req", read: "Acts 18.24 through 19.7"}] },
            "Friday" =>   %{title: "Friday",
      ...
      "proper" =>
        %{"1" =>
          ...
          "Saturday" =>   %{title: "Saturday",
                            ...
                            ep1: [%{style: "req", read: "1 Sam 21.1 through 22.5"}],
