...
defmodule DailyReading do
  ...
  def psalm_map(list) when list |> is_list do
    list
      |> Enum.map(fn(p)-> 
          if p |> is_tuple do
            {ps, v1, v2} = p
            %{style: "req", read: "Psalm #{ps} #{v1}-#{v2}"}
          else
            %{style: "req", read: "Psalm #{p}"}
          end
        end)
  end
  ...
  def build do
      ...
      "advent" =>
        %{"1" =>
          %{  "Sunday" =>     %{  title: "First Sunday in Advent",
                            colors: ["violet", "blue"],
                            mp1: [%{style: "req", read: "Isa 1.1-20"},%{style: "opt", read: "Isa 1.21-31"}],
                            mp2: [%{style: "req", read: "Matt 24.1-28"}],
                            ep1: [%{style: "opt", read: "Isa 2:1-9"},%{style: "req", read: "Isa 2.10-end"}],
                            ep2: [%{style: "req", read: "John 3.1-21"}]
                            },
              "Monday" =>     %{  title: "Monday",
                              colors: ["violet", "blue"],
                              mp1: [%{style: "req", read: "Isa 3.1-15"},%{style: "opt", read: "Isa 3.16-26"}],
              ...
              "Thursday" =>   %{  title: "Thursday",
                                colors: ["violet", "blue"],
                                mp1: [%{style: "req", read: "Isa 10.24-34"},%{style: "opt", read: "Isa 11.1-10"}],
          ...
          "2" =>
            %{"Sunday" =>     %{title: "Second Sunday in Advent",
                            ...
                            ep1: [%{style: "opt", read: "Isa 5.17-30"},%{style: "req", read: "Isa 18-end"}],
                            ep2: [%{style: "req", read: "Luke 1.1-25"}]
                            },
              "Monday" =>     %{title: "Monday",
                              colors: ["violet", "blue"],
                            mp1: [%{style: "req", read: "Isa 19.18-end"},%{style: "opt", read: "Isa 20"}],
                            mp2: [%{style: "req", read: "Mark 4.21-end"}],
                            ep1: [%{style: "req", read: "Isa 21.1-12"},%{style: "opt", read: "Isa 21.13-17"}],
                            ep2: [%{style: "req", read: "Rev 12"}],
                            },
              "Tuesday" =>    %{title: "Tuesday",
                              colors: ["violet", "blue"],
                            mp1: [%{style: "req", read: "Isa 22.1-14"},%{style: "opt", read: "Isa 22.15-25"}],
                            mp2: [%{style: "req", read: "Mark 5.1-20"}],
                            ep1: [%{style: "opt", read: "Isa 23"},%{style: "req", read: "Isa 24"}],
                            ep2: [%{style: "req", read: "Rev 13"}]
                            },
              "Wednesday" =>  %{ title: "Wednesday",
                              colors: ["violet", "blue"],
                              mp1: [%{style: "opt", read: "Isa 27"},%{style: "req", read: "Isa 28.1-8"},%{style: "opt", read: "Isa 21.9-end"}],
              ...
              "Friday" =>     %{title: "Friday",
                              colors: ["violet", "blue"],
                            mp1: [%{style: "req", read: "Isa 34"},%{style: "opt", read: "Isa 36"}],
                            mp2: [%{style: "req", read: "Mark 6.14-29"}],
                            ep1: [%{style: "opt", read: "Isa 37"},%{style: "req", read: "Isa 38"}],
                            ep2: [%{style: "req", read: "Rev 16"}],},
              "Saturday" =>   %{title: "Saturday",
                              colors: ["violet", "blue"],
                            mp1: [%{style: "opt", read: "Isa 39"},%{style: "req", read: "Isa 40.12-end"}],
          ...
          "3" =>
            %{"Sunday" =>     %{title: "Third Sunday in Advent",
                            ...
                            mp1: [%{style: "req", read: "Isa 25.1-9"},%{style: "opt", read: "Isa 25.10-12"}],
                            mp2: [%{style: "req", read: "Matt 25.1-30"}],
                            ep1: [%{style: "req", read: "Isa 26.1-13"},%{style: "opt", read: "Isa 26.14-end"}],
          ...
          %{"christmasEve" => %{  title: "Christmas Eve",
            ...
            "christmasDay" => %{  title: "Christmas Day",
                            colors: ["white", "gold"],
                                ...
                                mp2: [%{style: "opt", read: "Matt 1.1-17"},%{style: "req", read: "Matt 1.18-25"}],
                                ep1: [%{style: "req", read: "Isa 7.10-14"},%{style: "opt", read: "Isa 7.15-25"}],
      ...
      %{
        "0" =>
          %{"Epiphany" => %{title: "Epiphany",
                          colors: ["white", "gold"],
                            ...
                            mp2: [%{style: "req", read: "Luke 3.15-22"},%{style: "opt", read: "Luke 3.23-28"}],
        ...
        "1" =>
          %{"Sunday" =>   %{title: "First Sunday of Epiphany",
                          colors: ["white", "gold"],
                            ...
                            mp2: [%{style: "req", read: "John 4.1-26"},%{style: "opt", read: "John 4.27-42"}],
                            ep1: [%{style: "req", read: "Isa 61"}],
            ...
            "Thursday" => %{title: "Thursday",
                            colors: ["white", "gold"],
                            mp1: [%{style: "req", read: "Hos 2.14-3 end"}],
                            mp2: [%{style: "req", read: "Matt 10.24-end"}],
                            ep1: [%{style: "req", read: "Hos 4.1-11"},%{style: "opt", read: "Hos 4.12-19"}],
                            ep2: [%{style: "req", read: "Gal 4.1-5.1"}]
                            },
            "Friday" =>   %{title: "Friday",
                            colors: ["white", "gold"],
                            mp1: [%{style: "opt", read: "Hos 5:1-7"},%{style: "req", read: "Hos 5.8-6.6"},%{style: "opt", read: "Hos 6.7-11"}],
                            mp2: [%{style: "req", read: "Matt 11"}],
                            ep1: [%{style: "opt", read: "Hos 7"},%{style: "req", read: "Hos 8"}],
        ...
        "2" =>
          %{"Sunday" =>   %{title: "Second Sunday of Epiphany",
            ...
            "Tuesday" =>  %{title: "Tuesday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Hos 13.1-14"},%{style: "opt", read: "Hos 13.15-16"}],
        ...
        "3" =>
          %{"Sunday" =>   %{title: "Third Sunday of Epiphany",
            ...
            "Wednesday" => %{title: "Wednesday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Mal 3.13-4 end"}],
            ...
            "Thursday" => %{title: "Thursday",
                            ...
                            mp2: [%{style: "req", read: "1 Cor 12.27-13 end"}],
        ...
        "4" =>
          %{"Sunday" =>   %{title: "Fourth Sunday of Epiphany",
            ...
            "Monday" =>   %{title: "Monday",
                            colors: ["green"],
                            mp1: [%{style: "opt", read: "Jer 1:1-10"},%{style: "req", read: "Jer 1.11-end"}],
                            mp2: [%{style: "req", read: "2 Cor 1.1-2.11"}],
                            ep1: [%{style: "req", read: "Jer 2.1-13"},%{style: "opt", read: "Jer 2.14-3.25"}],
                            ep2: [%{style: "req", read: "2 Cor 2 12-3 end"}]
                            },
            "Tuesday" =>  %{title: "Tuesday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Jer 4.1-18"},%{style: "opt", read: "Jer 4.19-31"}],
            ...
            "Thursday" => %{title: "Thursday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Jer 7.1-28"},%{style: "opt", read: "Jer 7.29-34"}],
            ...
            "Friday" =>   %{title: "Friday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Jer 9.1-24"},%{style: "opt", read: "Jer 9.25-10.25"}],
                            mp2: [%{style: "req", read: "2 Cor 10"}],
                            ep1: [%{style: "req", read: "Jer 11"},%{style: "opt", read: "Jer 12"}],
                            ep2: [%{style: "req", read: "2 Cor 11"}]
                            },
            "Saturday" =>  %{title: "Saturday",
                            colors: ["green"],
                            mp1: [%{style: "opt", read: "Jer 13"},%{style: "req", read: "Jer 14"}],
                            mp2: [%{style: "req", read: "2 Cor 12.1-13"}],
                            ep1: [%{style: "req", read: "Jer 15"},%{style: "opt", read: "Jer 16"}],
        ...
        "5" =>
          %{"Sunday" =>   %{title: "Fifth Sunday of Epiphany",
            ...
            "Wednesday" => %{title: "Wednesday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Jer 23.9-32"},%{style: "opt", read: "Jer 23.33-40"}],
                            mp2: [%{style: "req", read: "Acts 17.16-end"}],
                            ep1: [%{style: "req", read: "Jer 30.1-22"},%{style: "opt", read: "Jer 30.23-24"}],
                            ep2: [%{style: "req", read: "Acts 18.1-23"}]
                            },
            "Thursday" => %{title: "Thursday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Jer 31.1-20"},%{style: "opt", read: "Jer 31.21-22"}],
        ...
        "6" =>
          %{"Sunday" =>   %{title: "Sixth Sunday of Epiphany",
            ...
            "Thursday" => %{title: "Thursday",
                            ...
                            ep1: [%{style: "req", read: "Baruch 4.36-5 end"}],
        ...
        "7" =>
          %{"Sunday" =>     %{title: "Seventh Sunday of Epiphany",
            ...
            "Wednesday" =>  %{title: "Wednesday",
                            ...
                            ep1: [%{style: "req", read: "Gen 8.15-9.17"},%{style: "opt", read: "Gen 9.18-29"}],
                            ep2: [%{style: "req", read: "Rom 3"}]
                            },
            "Thursday" =>   %{title: "Thursday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Gen 11.1-9, 27-12.10"},%{style: "opt", read: "Gen 12.11-20"}],
            ...
            "Saturday" =>   %{title: "Saturday",
                            ...
                            ep1: [%{style: "req", read: "Gen 17.1-22"},%{style: "opt", read: "Gen 17.23-27"}],
        ...
        "8" =>
          %{"Sunday" =>   %{title: "Eighth Sunday of Epiphany",
                          colors: ["green"],
                            mp1: [%{style: "req", read: "Gen 3"}],
                            mp2: [%{style: "req", read: "1 Cor 10.1-13"},%{style: "opt", read: "1 Cor 10.14-24"}],
            ...
            "Thursday" => %{title: "Thursday",
                            ...
                            ep1: [%{style: "opt", read: "Gen 25.1-6"},%{style: "req", read: "Gen 25.7-11, 19-end"}],
                            ep2: [%{style: "req", read: "Rom 9"}]
                            },
            "Friday" =>   %{title: "Friday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Gen 26.1-5"},%{style: "opt", read: "Gen 26.6-11"},%{style: "req", read: "Gen 26.12-end"}],
            ...
            "Saturday" => %{title: "Saturday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Gen 27.41-28 end"}],
                            mp2: [%{style: "req", read: "Matt22.14-23.12"}],
                            ep1: [%{style: "req", read: "Gen 29.1-20"},%{style: "opt", read: "Gen 29.21-30.43"}],
        ...
        "9" =>
          %{"Sunday" => %{title: "The Last Sunday of Epiphany [Transfiguration]",
            ...
            "Thursday" => %{title: "Thursday",
                            colors: ["violet"],
                            mp1: [%{style: "req", read: "Gen 35.1-20"},%{style: "opt", read: "Gen 35.21-29"}],
                            mp2: [%{style: "req", read: "Matt 24.29-end"}],
                            ep1: [%{style: "req", read: "Gen 37"},%{style: "opt", read: "Gen 38"}],
          ...
          %{"Sunday" =>     %{title: "First Sunday in Lent",
           ...
           "Friday" =>     %{title: "Friday Ember Day",
                          colors: ["violet"],
                            ...
                            ep1: [%{style: "req", read: "Gen 49.33-50 end"}],
                            ep2: [%{style: "req", read: "Col 1.1-20"}]
                            },
           "Saturday" =>   %{title: "Saturday Ember Day",
                          colors: ["violet"],
                            mp1: [%{style: "req", read: "Exod 1.1-14"},%{style: "opt", read: "Exod 1.15-21"},%{style: "req", read: "Exod 1.22-2.10"}],
        ...
        "2" =>
          %{"Sunday" =>   %{title: "Second Sunday in Lent",
                          colors: ["violet"],
                            ...
                            ep1: [%{style: "req", read: "Gen 9.1-17"},%{style: "opt", read: "Gen 11.1-9"}],
                            ep2: [%{style: "req", read: "Mark 14.27-52"}]
                            },
           "Monday" =>   %{title: "Monday",
                          colors: ["violet"],
                            mp1: [%{style: "req", read: "Exod 2.23-3 end"}],
                            mp2: [%{style: "req", read: "John 1.1-28"}],
                            ep1: [%{style: "req", read: "Exod 4.1-23"},%{style: "opt", read: "Exod 4.24-26"}],
           ...
           "Friday" =>   %{title: "Friday",
                          colors: ["violet"],
                            ...
                            ep1: [%{style: "req", read: "Exod 10.21-11 end"}],
          ...
          %{"Sunday" =>   %{title: "Third Sunday in Lent",
           ...
           "Thursday" => %{title: "Thursday",
            ...
            "Friday" =>   %{title: "Friday",
                            ...
                            mp2: [%{style: "req", read: "John 6.22-40"}],
                            ep1: [%{style: "req", read: "Exod 20.1-21"},%{style: "opt", read: "Exod 20.22-21.36"}],
                            ep2: [%{style: "req", read: "Eph 5.22-6.9"}]
                            },
            "Saturday" => %{title: "Saturday",
                            colors: ["violet"],
                            mp1: [%{style: "opt", read: "Exod 22.1-19"},%{style: "req", read: "Exod 22.20-23.17"}],
                            mp2: [%{style: "req", read: "John 6.41-end"}],
                            ep1: [%{style: "opt", read: "Exod 23.1-17"},%{style: "req", read: "Exod 23.18-end"}],
        ...
        "4" =>
          %{"Sunday" =>   %{title: "Fourth Sunday in Lent",
            ...
            "Monday" =>   %{title: "Monday",
                            ...
                            ep1: [%{style: "req", read: "Exod 25.1-22"},%{style: "opt", read: "Exod 25.23-26.37"}],
                            ep2: [%{style: "req", read: "1 Tim 1.1-17"}]
                            },
            "Tuesday" =>  %{title: "Tuesday",
                            colors: ["violet"],
                            mp1: [%{style: "opt", read: "Exod 27"},%{style: "req", read: "Exod 28.1-4"},%{style: "opt", read: "Exod 28.5-28"},%{style: "req", read: "Exod 28.29-43"}],
                            mp2: [%{style: "req", read: "John 7.25-end"}],
                            ep1: [%{style: "opt", read: "Exod 29.1-37"},%{style: "req", read: "Exod 29.38-30.16"},%{style: "opt", read: "Exod 30.17-38"}],
                            ep2: [%{style: "req", read: "1 Tim 1.18-2 end"}]
                            },
            "Wednesday" => %{title: "Wednesday",
                            colors: ["violet"],
                            mp1: [%{style: "opt", read: "Exod 31"},%{style: "req", read: "Exod 32"}],
            ...
            "Thursday" => %{title: "Thursday",
                            colors: ["violet"],
                            mp1: [%{style: "req", read: "Exod 35"},%{style: "opt", read: "Exod 36"}],
                            mp2: [%{style: "req", read: "John 8.31-end"}],
                            ep1: [%{style: "opt", read: "Exod 37"},%{style: "req", read: "Exod 38"}],
                            ep2: [%{style: "req", read: "1 Tim 4"}]
                            },
            "Friday" =>   %{title: "Friday",
                            colors: ["violet"],
                            mp1: [%{style: "opt", read: "Exod 39"},%{style: "opt", read: "Exod 40.1-16"},%{style: "req", read: "Exod 40.17-end"}],
        ...
        "5" =>
          %{"Sunday" =>   %{title: "Fifth Sunday in Lent [Passion]",
            ...
            "Tuesday" =>  %{title: "Tuesday",
                            ...
                            ep2: [%{style: "req", read: "Titus 2.9-3 end"}]
                            },
            "Wednesday" => %{title: "Wednesday",
                            colors: ["violet"],
            ...
            "Thursday" => %{title: "Thursday",
                            ...
                            ep1: [%{style: "req", read: "Num 16.36-17 end"}],
            ...
            "Saturday" => %{title: "Saturday",
                            ...
                            ep1: [%{style: "req", read: "Num 23.27-24 end"}],
      ...
      %{"1" =>
          %{"Sunday" =>   %{title: "Easter Day",
            ...
            "Thursday" => %{title: "Thursday of Easter Week",
                            ...
                            ep1: [%{style: "req", read: "Song of Solomon 4.16b-5 end"}],
            ...
            "Saturday" => %{title: "Saturday of Easter Week",
                            ...
                            ep1: [%{style: "req", read: "Song of Solomon 7.11-8 end"}],
    ...
    "easter" =>
      %{"2" =>
          %{"Sunday" =>   %{title: "Second Sunday of Easter",
            ...
            "Monday" =>   %{title: "Monday",
                            colors: ["white"],
                            mp1: [%{style: "opt", read: "Deut 1.1-2"},%{style: "req", read: "Deut 1.3-18"}],
            ...
            "Wednesday" => %{title: "Wednesday",
                            colors: ["white"],
                            mp1: [%{style: "opt", read: "Deut 3.6-17"},%{style: "req", read: "Deut 3.18-end"}],
            ...
            "Friday" =>   %{title: "Friday",
                            ...
                            mp2: [%{style: "req", read: "Acts 6.1-7, 16"}],
        ...
        "3" =>
          %{"Sunday" =>   %{title: "Third Sunday of Easter",
            ...
            "Thursday" => %{title: "Thursday",
                            colors: ["white"],
                            mp1: [%{style: "req", read: "Deut 12.1-14"},%{style: "opt", read: "Deut 12.15-13.18"}],
                            mp2: [%{style: "req", read: "Acts 11.19-end"}],
                            ep1: [%{style: "opt", read: "Deut 14"},%{style: "req", read: "Deut 15.1-18"}],
            ...
            "Friday" =>   %{title: "Friday",
                            ...
                            ep1: [%{style: "opt", read: "Deut 17.1-7"},%{style: "req", read: "Deut 17.8-end"}],
                            ep2: [%{style: "req", read: "Acts 13.13-43"}]
                            },
            "Saturday" => %{title: "Saturday",
                            colors: ["white"],
                            mp1: [%{style: "opt", read: "Deut 18.1-8"},%{style: "req", read: "Deut 18.9-end"}],
                            mp2: [%{style: "req", read: "Acts 13.44-14.7"}],
                            ep1: [%{style: "req", read: "Deut 19"},%{style: "opt", read: "Deut 20"}],
        ...
        "4" =>
          %{"Sunday" =>   %{title: "Fourth Sunday of Easter",
            ...
            "Wednesday" => %{title: "Wednesday",
                            colors: ["white"],
                            mp1: [%{style: "opt", read: "Deut 29.1-9"},%{style: "req", read: "Deut 29.10-end"}],
      ...
      %{"1" =>
          %{"Sunday" =>   %{title: "Pentecost",
            ...
            "Tuesday" =>  %{title: "Tuesday",
                            ...
                            ep2: [%{style: "req", read: "1 Cor 12.27-13 end"}]
                            },
            "Wednesday" => %{title: "Wednesday Ember Day",
                            colors: ["violet"],
    ...
    "proper" =>
      %{"1" =>
          %{"Sunday" =>   %{title: "Sunday closest to May 11",
                          colors: ["green"],
                            mp1: [%{style: "req", read: "Gen 3"}],
                            mp2: [%{style: "req", read: "1 Cor 10.1-13"},%{style: "opt", read: "1 Cor 10.14-24"}],
                            ep1: [%{style: "req", read: "Gen 4.1-15"}],
        ...
        "2" =>
          %{"Sunday" => %{title: "Sunday closest to May 18",
                          colors: ["green"],
                            mp1: [%{style: "req", read: "Gen 12.1-9"}],
        ...
        "3" =>
          %{"Sunday" =>   %{title: "Sunday closest to May 25",
            ...
            "Tuesday" =>  %{title: "Tuesday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Job 15.1-16"},%{style: "opt", read: "Job 15.17-35"}],
            ...
            "Thursday" => %{title: "Thursday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Job 19"},%{style: "opt", read: "Job 20"}],
        ...
        "4" =>
          %{"Sunday" =>   %{title: "Sunday closest to June 1",
            ...
            "Thursday" => %{title: "Thursday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Job 36"},%{style: "opt", read: "Job 37"}],
        ...
        "5" =>
          %{"Sunday" =>   %{title: "Sunday closest to June 8",
                          colors: ["green"],
                            ...
                            ep2: [%{style: "req", read: "Acts 2.22-42"},%{style: "opt", read: "Acts 2.43-end"}]
                            },
            "Monday" =>   %{title: "Monday",
                            colors: ["green"],
            ...
            "Wednesday" => %{title: "Wednesday",
                            ...
                            ep1: [%{style: "req", read: "Prov 4.20-5.14"},%{style: "opt", read: "Prov 5.15-23"}],
                            ep2: [%{style: "req", read: "Mark 12.35-13.13"}]
                            },
            "Thursday" => %{title: "Thursday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Prov 6.1-19"},%{style: "opt", read: "Prov 6.20-35"}],
                            mp2: [%{style: "req", read: "1 John 5"}],
                            ep1: [%{style: "opt", read: "Prov 7"},%{style: "req", read: "Prov 8"}],
        ...
        "6" =>
          %{"Sunday" =>     %{title: "Sunday closest to June 15",
                          colors: ["green"],
                            ...
                            ep2: [%{style: "req", read: "Acts 3.1-16"},%{style: "opt", read: "Acts 3.17-end"}]
                            },
            "Monday" =>     %{title: "Monday",
                            colors: ["green"],
            ...
            "Wednesday" =>  %{title: "Wednesday",
                            ...
                            ep2: [%{style: "req", read: "Mark 15.42-16 end"}]
                            },
            "Thursday" =>   %{title: "Thursday",
                            colors: ["green"],
        ...
        "7" =>
          %{"Sunday" =>     %{title: "Sunday closest to June 22",
                          colors: ["green"],
                            ...
                            ep2: [%{style: "req", read: "Acts 4.1-22"},%{style: "opt", read: "Acts 4.23-31"}]
                            },
            "Monday" =>     %{title: "Monday",
                            colors: ["green"],
            ...
            "Wednesday" =>  %{title: "Wednesday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "1 Sam 4"},%{style: "opt", read: "1 Sam 5"}],
                            mp2: [%{style: "req", read: "Rom 8.1-17"}],
                            ep1: [%{style: "opt", read: "1 Sam 6"},%{style: "req", read: "1 Sam 7"}],
        ...
        "8" =>
          %{"Sunday" =>     %{title: "Sunday closest to June 29",
            ...
            "Tuesday" =>    %{title: "Tuesday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "1 Sam 14.24-48"},%{style: "opt", read: "1 Sam 14.49-52"}],
            ...
            "Thursday" =>   %{title: "Thursday",
                            ...
                            ep1: [%{style: "req", read: "1 Sam 17.55-18.16"},%{style: "opt", read: "1 Sam 18.17-30"}],
        ...
        "9" =>
          %{"Sunday" =>     %{title: "Sunday closest to July 6",
                          colors: ["green"],
                            ...
                            ep1: [%{style: "req", read: "Jer 52.1-11"},%{style: "opt", read: "Jer 52.12-34"}],
            ...
            "Wednesday" =>  %{title: "Wednesday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "1 Sam 26"},%{style: "opt", read: "1 Sam 27"}],
                            mp2: [%{style: "req", read: "1 Cor 1.1-25"}],
                            ep1: [%{style: "opt", read: "1 Sam 28:1-2"},%{style: "req", read: "1 Sam 28.3-end"},%{style: "opt", read: "1 Sam 29"}],
                            ep2: [%{style: "req", read: "Luke 9.1-17"}]
                            },
            "Thursday" =>   %{title: "Thursday",
                            colors: ["green"],
                            mp1: [%{style: "opt", read: "1 Sam 30"},%{style: "req", read: "1 Sam 31"}],
            ...
            "Friday" =>     %{title: "Friday",
                            ...
                            ep1: [%{style: "opt", read: "2 Sam 3.2-16"},%{style: "req", read: "2 Sam 3.17-end"}],
                            ep2: [%{style: "req", read: "Luke 9.51-end"}]
                            },
            "Saturday" =>   %{title: "Saturday",
                            colors: ["green"],
                            mp1: [%{style: "opt", read: "2 Sam 4"},%{style: "req", read: "2 Sam 5.1-12"}],
        ...
        "10" =>
          %{"Sunday" =>     %{title: "Sunday closest to July 13",
            ...
            "Wednesday" =>  %{title: "Wednesday",
                            colors: ["green"],
                            mp1: [%{style: "opt", read: "2 Sam 12"},%{style: "opt", read: "2 Sam 13.1-37"},%{style: "req", read: "2 Sam 13.38-14.24"}],
                            mp2: [%{style: "req", read: "1 Cor 7"}],
        ...
        "11" =>
          %{"Sunday" =>     %{title: "Sunday closest to July 20",
            ...
            "Monday" =>     %{title: "Monday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "2 Sam 20"},%{style: "opt", read: "2 Sam 21"}],
                            mp2: [%{style: "req", read: "1 Cor 11.2-end"}],
                            ep1: [%{style: "opt", read: "2 Sam 22"},%{style: "req", read: "2 Sam 23.1-17"},%{style: "opt", read: "2 Sam 23.18-39"}],
            ...
            "Tuesday" =>    %{title: "Tuesday",
                            ...
                            ep1: [%{style: "opt", read: "1 Kings 1.1-4"},%{style: "req", read: "1 Kings 1.5-31"}],
                            ep2: [%{style: "req", read: "Luke 14.1-24"}]
                            },
            "Wednesday" =>  %{title: "Wednesday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "1 Kings 1.32-end"},%{style: "opt", read: "1 Kings 2"}],
                            mp2: [%{style: "req", read: "1 Cor 12.27-13 end"}],
            ...
            "Friday" =>     %{title: "Friday",
                            ...
                            mp2: [%{style: "req", read: "1 Cor 14.20-end"}],
                            ep1: [%{style: "opt", read: "1 Kings 4.1-20"},%{style: "req", read: "1 Kings 4.21-end"}],
            ...
            "Saturday" =>   %{title: "Saturday",
                            ...
                            ep1: [%{style: "req", read: "1 Kings 6.1-14"},%{style: "opt", read: "1 Kings 6.15-38"}],
        ...
        "12" =>
          %{"Sunday" =>     %{title: "Sunday closest to July 27",
            ...
            "Monday" =>     %{title: "Monday",
                            colors: ["green"],
                            mp1: [%{style: "opt", read: "1 Kings 7"},%{style: "req", read: "1 Kings 8.1-21"}],
                            mp2: [%{style: "req", read: "1 Cor 15.35-end"}],
            ...
            "Tuesday" =>    %{title: "Tuesday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "1 Kings 8.54-9.9"},%{style: "opt", read: "1 Kings 9.10-28"}],
            ...
            "Wednesday" =>  %{title: "Wednesday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "1 Kings 11.1-13"},%{style: "opt", read: "1 Kings 11.14-25"},%{style: "req", read: "1 Kings 11.26-end"}],
            ...
            "Thursday" =>   %{title: "Thursday",
                            ...
                            mp2: [%{style: "req", read: "2 Cor 1.23-2 end"}],
                            ep1: [%{style: "req", read: "1 Kings 13.11-end"}],
                            ep2: [%{style: "req", read: "Luke 19.11-28"}]
                            },
            "Friday" =>     %{title: "Friday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "1 Kings 14.1-20"},%{style: "opt", read: "1 Kings 14.21-31"}],
        ...
        "13" =>
          %{"Sunday" =>     %{title: "Sunday closest to August 3",
            ...
            "Thursday" =>   %{title: "Thursd",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "1 Kings 19"},%{style: "opt", read: "1 Kings 20"}],
                            mp2: [%{style: "req", read: "2 Cor 8"}],
            ...
            "Friday" =>     %{title: "Friday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "1 Kings 22.1-40"},%{style: "opt", read: "1 Kings 22.41-53"}],
            ...
            "Saturday" =>   %{title: "Saturday",
                            ...
                            mp2: [%{style: "req", read: "2 Cor 10"}],
                            ep1: [%{style: "req", read: "2 Kings 2.1-22"},%{style: "opt", read: "2 Kings 2.23-25"},%{style: "opt", read: "2 Kings 3"}],
        ...
        "14" =>
          %{"Sunday" =>     %{title: "Sunday closest to August 10",
            ...
            "Monday" =>     %{title: "Monday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "2 Kings 4.1-37"},%{style: "opt", read: "2 Kings 4.38-44"}],
            ...
            "Wednesday" =>  %{title: "Wednesday",
                            ...
                            ep1: [%{style: "req", read: "2 Kings 8.1-15"},%{style: "opt", read: "2 Kings 8.16-29"}],
                            ep2: [%{style: "req", read: "Luke 24.13-end"}]
                            },
            "Thursday" =>   %{title: "Thursday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "2 Kings 9"},%{style: "opt", read: "2 Kings 10"}],
            ...
            "Friday" =>     %{title: "Friday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "2 Kings 11.21-12 end"}],
        ...
        "15" =>
          %{"Sunday" =>     %{title: "Sunday closest to August 17",
            ...
            "Monday" =>     %{title: "Monday",
                            colors: ["green"],
                            mp1: [%{style: "opt", read: "2 Kings 15.1-16"},%{style: "req", read: "2 Kings 15.17-end"}],
            ...
            "Thursday" =>   %{title: "Thursday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "2 Kings 18.1-8"},%{style: "opt", read: "2 Kings 18.9-12"}],
            ...
            "Saturday" =>   %{title: "Saturday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "2 Kings 20"},%{style: "opt", read: "2 Kings 21"}],
        ...
        "16" =>
          %{"Sunday" =>     %{title: "Sunday closest to August 24",
            ...
            "Thursday" =>   %{title: "Thursday",
                            ...
                            ep1: [%{style: "req", read: "Jer 21.1-10"},%{style: "opt", read: "Jer 21.11-14"}],
                            ep2: [%{style: "req", read: "John 7.1-24"}]
                            },
            "Friday" =>     %{title: "Friday",
                            colors: ["green"],
                            mp1: [%{style: "opt", read: "Jer 22.1-19"},%{style: "req", read: "Jer 22.20-23.8 "}],
            ...
            "Saturday" =>   %{title: "Saturday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Jer 25.1-14"},%{style: "opt", read: "Jer 25.15-38"}],
        ...
        "17" =>
          %{"Sunday" =>     %{title: "Sunday closest to August 31",
            ...
            "Thursday" =>   %{title: "Thursday",
                            ...
                            ep1: [%{style: "opt", read: "Jer 34.1-7"},%{style: "req", read: "Jer 34.8-end"}],
                            ep2: [%{style: "req", read: "John 10.22-end"}]
                            },
            "Friday" =>     %{title: "Friday",
                            colors: ["green"],
                            mp1: [%{style: "opt", read: "Jer 36"},%{style: "req", read: "Jer 37"}],
            ...
            "Saturday" =>   %{title: "Saturday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Jer 38.14-end"},%{style: "opt", read: "Jer 39"}],
                            mp2: [%{style: "req", read: "Phil 2.12-end"}],
                            ep1: [%{style: "req", read: "Jer 40"},%{style: "opt", read: "Jer 41"}],
        ...
        "18" =>
          %{"Sunday" =>     %{title: "Sunday closest to September 7",
                          colors: ["green"],
                            ...
                            ep1: [%{style: "req", read: "Dan 6.1-23"},%{style: "opt", read: "Dan 6.24-28"}],
                            ep2: [%{style: "req", read: "Matt 7.15-end"}]
                            },
            "Monday" =>     %{title: "Monday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Jer 42"},%{style: "opt", read: "Jer 43"}],
                            mp2: [%{style: "req", read: "Phil 3"}],
                            ep1: [%{style: "req", read: "Jer 44"},%{style: "opt", read: "Jer 45"}],
                            ep2: [%{style: "req", read: "John 12.1-19"}]
                            },
            "Tuesday" =>    %{title: "Tuesday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Jer 46"},%{style: "opt", read: "Jer 47"}],
                            mp2: [%{style: "req", read: "Phil 4"}],
                            ep1: [%{style: "req", read: "Jer 48"},%{style: "opt", read: "Jer 49"}],
        ...
        "19" =>
          %{"Sunday" =>     %{title: "Sunday closest to September 14",
            ...
            "Saturday" =>   %{title: "Saturday",
                            ...
                            mp2: [%{style: "req", read: "1 Thess 2.17-3 end"}],
        ...
        "20" =>
          %{"Sunday" =>     %{title: "Sunday closest to September 21",
            ...
            "Thursday" =>   %{title: "Thursday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Ezra 1"},%{style: "opt", read: "Ezra 2"}],
            ...
            "Saturday" =>   %{title: "Saturday",
                            ...
                            ep1: [%{style: "req", read: "Zech 1.18-2 end"}],
                            ep2: [%{style: "req", read: "Heb 4.14-5.10"}]
                            }
            },
        "21" =>
          %{"Sunday" =>     %{title: "Sunday closest to September 28",
            ...
            "Monday" =>     %{title: "Monday",
                            ...
                            ep1: [%{style: "req", read: "Zech 4"},%{style: "opt", read: "Zech 5"}],
            ...
            "Tuesday" =>    %{title: "Tuesday",
                            ...
                            ep1: [%{style: "req", read: "Zech 7"},%{style: "opt", read: "Zech 8"}],
                            ep2: [%{style: "req", read: "Heb 7"}]
                            },
            "Wednesday" =>  %{title: "Wednesday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Zech 9"},%{style: "opt", read: "Zech 10"}],
                            mp2: [%{style: "req", read: "1 Tim 3"}],
                            ep1: [%{style: "req", read: "Zech 11"},%{style: "opt", read: "Zech 12"}],
                            ep2: [%{style: "req", read: "Heb 8"}]
                            },
            "Thursday" =>   %{title: "Thursday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Zech 13"},%{style: "opt", read: "Zech 14"}],
        ...
        "22" =>
          %{"Sunday" =>     %{title: "Sunday closest to October 5",
            ...
            "Tuesday" =>    %{title: "Tuesday",
                            ...
                            mp2: [%{style: "req", read: "Titus 2.9-3 end"}],
            ...
            "Saturday" =>   %{title: "Saturday",
                            colors: ["green"],
                            mp1: [%{style: "opt", read: "Neh 12.17-end"},%{style: "req", read: "Neh 13"}],
        ...
        "23" =>
          %{"Sunday" =>     %{title: "Sunday closest to October 12",
                          colors: ["green"],
                            mp1: [%{style: "req", read: "Wisd 2"}, %{style: "alt", read: "Prov 2"}],
                            mp2: [%{style: "req", read: "Luke 12.35-end"}],
                            ep1: [%{style: "req", read: "Ecclus 4.11-28"}, %{style: "alt", read: "Dan 1"}],
            ...
            "Wednesday" =>  %{title: "Wednesday",
                            colors: ["green"],
                            mp1: [%{style: "opt", read: "Dan 7.1-8"},%{style: "req", read: "Dan 7.9-end"},%{style: "opt", read: "Dan 8"}],
                            mp2: [%{style: "req", read: "Jas 3"}],
            ...
            "Thursday" =>   %{title: "Thursday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Dan 10"},%{style: "opt", read: "Dan 11"}],
                            mp2: [%{style: "req", read: "Jas 5"}],
        ...
        "24" =>
          %{"Sunday" =>     %{title: "Sunday closest to October 19",
                          colors: ["green"],
                            mp1: [%{style: "req", read: "Wisd 4.7-17"}, %{style: "alt", read: "Prov 9.1-11"}],
                            mp2: [%{style: "req", read: "Luke 13.18-end"}],
                            ep1: [%{style: "req", read: "Ecclus 4.29-6.1"}, %{style: "alt", read: "Dan 2.1-23"}],
            ...
            "Tuesday" =>    %{title: "Tuesday",
                            ...
                            mp2: [%{style: "req", read: "1 Pet 5"}],
                            ep1: [%{style: "req", read: "Eccles 2.1-23"},%{style: "opt", read: "Eccles 2.24-26"}],
            ...
            "Saturday" =>   %{title: "Saturday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Eccles 9"},%{style: "opt", read: "Eccles 10"}],
                            mp2: [%{style: "req", read: "2 John"}],
                            ep1: [%{style: "opt", read: "Eccles 11"},%{style: "req", read: "Eccles 12"}],
        ...
        "25" =>
          %{"Sunday" =>     %{title: "Sunday closest to October 26",
                          colors: ["green"],
                            mp1: [%{style: "req", read: "Wisd 6.1-21"}, %{style: "alt", read: "Prov 16.9-20"}],
                            mp2: [%{style: "req", read: "Luke 14.15-end"}],
                            ep1: [%{style: "req", read: "Ecclus 11.7-28"}, %{style: "alt", read: "Dan 2.24-45"}],
        ...
        "26" =>
          %{"Sunday" =>     %{title: "Sunday closest to November 2",
                          colors: ["green"],
                            mp1: [%{style: "req", read: "Wisd 7.15-8.1"}, %{style: "alt", read: "Prov 25.11-end"}],
                            mp2: [%{style: "req", read: "Luke 15.1-10"}],
                            ep1: [%{style: "req", read: "Ecclus 15.11-end"}, %{style: "alt", read: "Dan 9.1-19"}],
            ...
            "Wednesday" =>  %{title: "Wednesday",
                            ...
                            ep1: [%{style: "req", read: "1 Macc 13.41-end"},%{style: "opt", read: "1 Macc 14.1-15"}],
        ...
        "27" =>
          %{"Sunday" =>     %{title: "Sunday closest to November 9",
                          colors: ["green"],
                            mp1: [%{style: "req", read: "2 Esdras 16.53-67"}, %{style: "alt", read: "Zech 1.7-end"}],
                            mp2: [%{style: "req", read: "Luke 17.1-10"}],
                            ep1: [%{style: "req", read: "Baruch 3.1-14"}, %{style: "alt", read: "Zech 9.9-12, 16"}],
        ...
        "28" =>
          %{"Sunday" =>     %{title: "Sunday closest to November 16",
                          colors: ["green"],
                            ...
                            ep1: [%{style: "req", read: "Baruch 4.36-5 end"}, %{style: "alt", read: "Zech 13"}],
        ...
        "29" =>
          %{"Sunday" =>     %{title: "Sunday closest to November 23",
            ...
            "Friday" =>     %{title: "Friday",
                            colors: ["green"],
                            mp1: [%{style: "req", read: "Wisd 8.21-9 end"}],
