...
var _user$project$MIndex$initModel = {config: _user$project$Iphod_Models$configInit, eu: _user$project$Iphod_Models$sundayInit, mp: _user$project$Iphod_Models$initDailyMP, ep: _user$project$Iphod_Models$initDailyEP, reflection: _user$project$Iphod_Models$initReflection};
...
var _user$project$MIndex$Model = F5(
	function (a, b, c, d, e) {
		return {config: a, eu: b, mp: c, ep: d, reflection: e};
	});
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$MIndex$portLesson(_user$project$MIndex$UpdateLesson)
			]));
};
