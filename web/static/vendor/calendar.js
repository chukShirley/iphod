...
Elm.Iphod.Models.make = function (_elm) {
   ...
   var emailInit = {from: "",topic: "",text: "",show: false};
   var Email = F4(function (a,b,c,d) {
      return {from: a,topic: b,text: c,show: d};
   });
      ...
      var req = function (l) {
         ...
         {case "MP1": return _U.list([{ctor: "_Tuple2"
            ...
            case "MP2": return _U.list([{ctor: "_Tuple2"
                                       ...
                                       ,{ctor: "_Tuple2",_0: "ver",_1: model.config.nt}
                                       ,{ctor: "_Tuple2",_0: "fnotes",_1: model.config.fnotes}]);
            case "MPP": return _U.list([{ctor: "_Tuple2"
                                        ,_0: "ofType"
                                        ,_1: "daily"}
                                       ,{ctor: "_Tuple2",_0: "section",_1: l.section}
                                       ,{ctor: "_Tuple2",_0: "id",_1: l.id}
...
Elm.Calendar.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var styleBorder = function (today) {
      return today ? $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                     ,_0: "border"
                                                     ,_1: "3px solid #555"}])) : $Html$Attributes.style(_U.list([]));
   };
   var day_classes = function (day) {
      var firstColor = A2($Maybe.withDefault,
      "green",
      $List.head(day.sunday.colors));
      var color_class = A2($Basics._op["++"],"day_",firstColor);
      return $Html$Attributes.$class(A2($Basics._op["++"],
      "day_of_month ",
      color_class));
   };
   var reading = function (lessons) {
      var this_reading = function (l) {
         return A2($Html.li,
         _U.list([$Html$Attributes.$class("reading_item")]),
         _U.list([$Html.text(l.read)]));
      };
      return A2($Html.ul,
      _U.list([$Html$Attributes.$class("reading_list")]),
      A2($List.map,this_reading,lessons));
   };
   var httpReferences = F2(function (ante,date) {
      var id = A2($Basics._op["++"],
      ante,
      A4($Regex.replace,
      $Regex.All,
      ...
      date));
      var ref = A2($Basics._op["++"],"#",id);
      var close = A2($Basics._op["++"],"#close",id);
      return {ctor: "_Tuple3",_0: id,_1: ref,_2: close};
   });
   var readingsEU = function (sunday) {
      var _p1 = A2(httpReferences,"he",sunday.date);
      var thisId = _p1._0;
      var thisRef = _p1._1;
      var thisClose = _p1._2;
      return _U.list([A2($Html.a,
                     _U.list([$Html$Attributes.href(thisRef)]),
                     _U.list([A2($Html.button,
                     _U.list([]),
                     _U.list([$Html.text("HE")]))]))
                     ,A2($Html.div,
                     _U.list([$Html$Attributes.id(thisId)
                             ,$Html$Attributes.$class("modalDialog")]),
                     _U.list([A2($Html.div,
                     _U.list([]),
                     _U.list([A2($Html.a,
                             _U.list([$Html$Attributes.href(thisClose)
                                     ,$Html$Attributes.title("Close")
                                     ,$Html$Attributes.$class("close")]),
                             _U.list([$Html.text("X")]))
                             ,A2($Html.h2,
                             _U.list([$Html$Attributes.$class("modal_header")]),
                             _U.list([$Html.text("Eucharistic Readings")
                                     ,A2($Html.br,_U.list([]),_U.list([]))
                                     ,$Html.text(sunday.date)]))
                             ,reading(sunday.ot)
                             ,reading(sunday.ps)
                             ,reading(sunday.nt)
                             ,reading(sunday.gs)]))]))]);
   };
   var readingsEP = function (daily) {
      var _p2 = A2(httpReferences,"ep",daily.date);
      var thisId = _p2._0;
      var thisRef = _p2._1;
      var thisClose = _p2._2;
      return _U.list([A2($Html.a,
                     _U.list([$Html$Attributes.href(thisRef)]),
                     _U.list([A2($Html.button,
                     _U.list([]),
                     _U.list([$Html.text("EP")]))]))
                     ,A2($Html.div,
                     _U.list([$Html$Attributes.id(thisId)
                             ,$Html$Attributes.$class("modalDialog")]),
                     _U.list([A2($Html.div,
                     ...
                     _U.list([A2($Html.a,
                             ...
                             _U.list([$Html.text("Evening Prayer")
                                     ,A2($Html.br,_U.list([]),_U.list([]))
                                     ,$Html.text(daily.date)]))
                             ,reading(daily.ep1)
                             ,reading(daily.ep2)
                             ,reading(daily.epp)]))]))]);
   };
   var readingsMP = function (daily) {
      var _p3 = A2(httpReferences,"mp",daily.date);
      var thisId = _p3._0;
      var thisRef = _p3._1;
      var thisClose = _p3._2;
      return _U.list([A2($Html.a,
                     _U.list([$Html$Attributes.href(thisRef)]),
                     _U.list([A2($Html.button,
                     _U.list([]),
                     _U.list([$Html.text("MP")]))]))
                     ,A2($Html.div,
                     _U.list([$Html$Attributes.id(thisId)
                             ,$Html$Attributes.$class("modalDialog")]),
                     _U.list([A2($Html.div,
   ...
   var colorOptions = function (day) {
      var thisColor = function (c) {
         return A2($Html.li,
         _U.list([$Html$Attributes.$class("reading_item")]),
         _U.list([$Html.text(c)]));
      };
      var _p4 = A2(httpReferences,"colors",day.sunday.date);
      var thisID = _p4._0;
      var thisRef = _p4._1;
      var thisClose = _p4._2;
      return _U.list([A2($Html.a,
                     _U.list([$Html$Attributes.href(thisRef)]),
                     _U.list([A2($Html.button,
                     _U.list([]),
                     _U.list([$Html.text(day.dayOfMonth)]))]))
                     ,A2($Html.div,
                     _U.list([$Html$Attributes.id(thisID)
                             ,$Html$Attributes.$class("modalDialog")]),
                     _U.list([A2($Html.div,
                     ...
                     _U.list([A2($Html.a,
                             ...
                             ,A2($Html.h2,
                             _U.list([$Html$Attributes.$class("modal_header")]),
                             _U.list([$Html.text("Color Options For")
                                     ,A2($Html.br,_U.list([]),_U.list([]))
                                     ,$Html.text(day.sunday.title)]))
                             ,A2($Html.ul,
                             _U.list([$Html$Attributes.$class("reading_list")]),
                             A2($List.map,thisColor,day.sunday.colors))]))]))]);
   };
   var oneWeek = F2(function (address,week) {
      var this_day = F2(function (address,d) {
         var title = A2($List.member,
         d.daily.title,
         _U.list(["Sunday"
                 ,"Monday"
                 ,"Tuesday"
                 ...
                 ,"Thursday"
                 ,"Friday"
                 ,"Saturday"])) ? "" : d.daily.title;
         return A2($Html.td,
         _U.list([styleBorder(d.today)]),
         _U.list([A2($Html.p,_U.list([day_classes(d)]),colorOptions(d))
                 ,A2($Html.p,
                 _U.list([$Html$Attributes.$class("cal_day_title")]),
                 _U.list([$Html.text(title)]))
                 ,A2($Html.ul,
                 _U.list([$Html$Attributes.$class("day_options")]),
                 _U.list([A2($Html.li,
                         _U.list([$Html$Attributes.$class("reading_group")]),
                         readingsMP(d.daily))
                         ,A2($Html.li,
                         _U.list([$Html$Attributes.$class("reading_group")]),
                         readingsEP(d.daily))
      ...
      return A2($Html.tr,
      _U.list([]),
      A2($List.map,this_day(address),week.days));
   });
   var calendarWeeks = F2(function (address,model) {
      return A2($List.map,oneWeek(address),model.calendar);
   });
   var calendarDayHeader = _U.list([A2($Html.tr,
   _U.list([]),
   _U.list([A2($Html.th,_U.list([]),_U.list([$Html.text("Sun")]))
           ,A2($Html.th,_U.list([]),_U.list([$Html.text("Mon")]))
           ,A2($Html.th,_U.list([]),_U.list([$Html.text("Tue")]))
           ,A2($Html.th,_U.list([]),_U.list([$Html.text("Wed")]))
           ,A2($Html.th,_U.list([]),_U.list([$Html.text("Thu")]))
           ,A2($Html.th,_U.list([]),_U.list([$Html.text("Fri")]))
           ,A2($Html.th,_U.list([]),_U.list([$Html.text("Sat")]))]))]);
   var mpEp = F2(function (action,model) {
      return _U.list([A2($Html.th,
   ...
   var dateNav = F2(function (address,model) {
      return A2($Html.th,
      _U.list([$Html$Attributes.colspan(5)]),
      _U.list([$Html.text(A2($String.join,
      ", ",
      _U.list([model.month,model.year])))]));
   });
   ...
   var calendarNavHeader = F2(function (address,model) {
      ...
      _U.list([A2($Html.th,
              ...
              ,A2($Html.th,
              _U.list([A2($Html$Events.onClick,address,NextMonth)]),
              _U.list([$Html.text(">")]))]))]);
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
      ...
      _U.list([$Html$Attributes.id("calendar")]),
      A2($Basics._op["++"],
      A2(mpEp,address,model),
      A2($Basics._op["++"],
      A2(calendarNavHeader,address,model),
      A2($Basics._op["++"],
      calendarDayHeader,
      A2(calendarWeeks,address,model)))))]));
   });
   var AddMonth = function (a) {
      return {ctor: "AddMonth",_0: a};
   };
   var NoOp = {ctor: "NoOp"};
   var thisMonth = Elm.Native.Port.make(_elm).inboundSignal("thisMonth",
   "Calendar.Model",
   function (v) {
      return typeof v === "object" && "calendar" in v && "month" in v && "year" in v ? {_: {}
                                                                                       ,calendar: typeof v.calendar === "object" && v.calendar instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.calendar.map(function (v) {
                                                                                          return typeof v === "object" && "days" in v ? {_: {}
                                                                                                                                        ,days: typeof v.days === "object" && v.days instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.days.map(function (v) {
                                                                                                                                           return typeof v === "object" && "name" in v && "color" in v && "dayOfMonth" in v && "date" in v && "daily" in v && "sunday" in v && "today" in v ? {_: {}
                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                              v.color)
                                                                                                                                                                                                                                                                                              ,dayOfMonth: typeof v.dayOfMonth === "string" || typeof v.dayOfMonth === "object" && v.dayOfMonth instanceof String ? v.dayOfMonth : _U.badPort("a string",
                                                                                                                                                                                                                                                                                              v.dayOfMonth)
                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                              v.daily)
                                                                                                                                                                                                                                                                                              ,sunday: typeof v.sunday === "object" && "ofType" in v.sunday && "date" in v.sunday && "season" in v.sunday && "week" in v.sunday && "title" in v.sunday && "colors" in v.sunday && "collect" in v.sunday && "ot" in v.sunday && "ps" in v.sunday && "nt" in v.sunday && "gs" in v.sunday && "show" in v.sunday && "config" in v.sunday ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        v.sunday.title)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ,colors: typeof v.sunday.colors === "object" && v.sunday.colors instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.sunday.colors.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        })) : _U.badPort("an array",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        v.sunday.colors)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ,collect: typeof v.sunday.collect === "object" && "instruction" in v.sunday.collect && "title" in v.sunday.collect && "collects" in v.sunday.collect && "show" in v.sunday.collect ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ,instruction: typeof v.sunday.collect.instruction === "string" || typeof v.sunday.collect.instruction === "object" && v.sunday.collect.instruction instanceof String ? v.sunday.collect.instruction : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             v.sunday.collect.instruction)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ,title: typeof v.sunday.collect.title === "string" || typeof v.sunday.collect.title === "object" && v.sunday.collect.title instanceof String ? v.sunday.collect.title : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             v.sunday.collect.title)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ,collects: typeof v.sunday.collect.collects === "object" && v.sunday.collect.collects instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.sunday.collect.collects.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             v.sunday.collect.collects)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ,show: typeof v.sunday.collect.show === "boolean" ? v.sunday.collect.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             v.sunday.collect.show)} : _U.badPort("an object with fields `instruction`, `title`, `collects`, `show`",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        v.sunday.collect)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        v.sunday.config)} : _U.badPort("an object with fields `ofType`, `date`, `season`, `week`, `title`, `colors`, `collect`, `ot`, `ps`, `nt`, `gs`, `show`, `config`",
                                                                                                                                                                                                                                                                                              v.sunday)
                                                                                                                                                                                                                                                                                              ,today: typeof v.today === "boolean" ? v.today : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                              v.today)} : _U.badPort("an object with fields `name`, `color`, `dayOfMonth`, `date`, `daily`, `sunday`, `today`",
                                                                                                                                           v);
                                                                                                                                        })) : _U.badPort("an array",
                                                                                                                                        v.days)} : _U.badPort("an object with fields `days`",
                                                                                          v);
                                                                                       })) : _U.badPort("an array",v.calendar)
                                                                                       ,month: typeof v.month === "string" || typeof v.month === "object" && v.month instanceof String ? v.month : _U.badPort("a string",
                                                                                       v.month)
                                                                                       ,year: typeof v.year === "string" || typeof v.year === "object" && v.year instanceof String ? v.year : _U.badPort("a string",
                                                                                       v.year)} : _U.badPort("an object with fields `calendar`, `month`, `year`",
      v);
   });
   var incomingMonth = A2($Signal.map,AddMonth,thisMonth);
   var changeMonth = $Signal.mailbox({ctor: "_Tuple3"
                                     ,_0: ""
                                     ,_1: ""
                                     ,_2: ""});
   var requestMoveMonth = Elm.Native.Port.make(_elm).outboundSignal("requestMoveMonth",
   function (v) {
      return [v._0,v._1,v._2];
   },
   changeMonth.signal);
   var getMonth = F2(function (model,movement) {
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return {ctor: "_Tuple2"
                           ,_0: model
                           ,_1: $Effects.none};
         case "AddMonth": return {ctor: "_Tuple2"
                                 ,_0: _p5._0
                                 ,_1: $Effects.none};
         case "LastMonth": return {ctor: "_Tuple2"
                                  ,_0: model
                                  ,_1: A2(getMonth,model,"last")};
         default: return {ctor: "_Tuple2"
                         ,_0: model
                         ,_1: A2(getMonth,model,"next")};}
   });
   var initModel = {calendar: _U.list([]),month: "",year: ""};
   var init = {ctor: "_Tuple2",_0: initModel,_1: $Effects.none};
   var Model = F3(function (a,b,c) {
      return {calendar: a,month: b,year: c};
   });
   var initWeek = {days: _U.list([])};
   var Week = function (a) {    return {days: a};};
   var app = $StartApp.start({init: init
                             ,update: update
                             ,view: view
                             ,inputs: _U.list([incomingMonth])});
   var main = app.html;
   ...
   return _elm.Calendar.values = {_op: _op
                                 ...
                                 ,getMonth: getMonth
                                 ,view: view
                                 ,calendarNavHeader: calendarNavHeader
                                 ,dateNav: dateNav
                                 ,mpEp: mpEp
                                 ...
                                 ,readingsMP: readingsMP
                                 ,readingsEP: readingsEP
                                 ,readingsEU: readingsEU
                                 ,httpReferences: httpReferences
                                 ,reading: reading
