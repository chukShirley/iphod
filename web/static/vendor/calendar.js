...
Elm.Calendar.make = function (_elm) {
   ...
   var oneWeek = F2(function (address,week) {
      var this_day = F2(function (address,d) {
         ...
         _U.list([]),
         _U.list([A2($Html.p,
                 _U.list([$Html$Attributes.$class("day_of_month")]),
                 _U.list([$Html.text(d.dayOfMonth)]))
                 ,A2($Html.ul,
                 _U.list([]),
                 _U.list([A2($Html.li,
   ...
   var dateNav = F2(function (address,model) {
      ...
      _U.list([$Html.text("MONTH PICKER GOES HERE")]));
   });
   var calendarNavHeader = F2(function (address,model) {
      ...
      _U.list([A2($Html.th,_U.list([]),_U.list([$Html.text("<")]))
              ...
              ,A2($Html.th,_U.list([]),_U.list([$Html.text(">")]))]))]);
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
   ...
   var update = F2(function (action,model) {
      ...
      if (_p4.ctor === "NoOp") {
            ...
            return {ctor: "_Tuple2",_0: _p4._0,_1: $Effects.none};
         }
   });
   ...
   "Calendar.Model",
   function (v) {
      return typeof v === "object" && "calendar" in v ? {_: {}
                                                           ...
                                                           return typeof v === "object" && "days" in v ? {_: {}
                                                                                                         ,days: typeof v.days === "object" && v.days instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.days.map(function (v) {
                                                                                                            return typeof v === "object" && "name" in v && "color" in v && "dayOfMonth" in v && "date" in v && "daily" in v && "sunday" in v ? {_: {}
                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                               v.daily)
                                                                                                                                                                                                                                               ,sunday: typeof v.sunday === "object" && "ofType" in v.sunday && "date" in v.sunday && "season" in v.sunday && "week" in v.sunday && "title" in v.sunday && "collect" in v.sunday && "ot" in v.sunday && "ps" in v.sunday && "nt" in v.sunday && "gs" in v.sunday && "show" in v.sunday && "config" in v.sunday ? {_: {}
                                                        ...
                                                        v.calendar)} : _U.badPort("an object with fields `calendar`",v);
   });
   var incomingMonth = A2($Signal.map,AddMonth,thisMonth);
   var initModel = {calendar: _U.list([])};
   var init = {ctor: "_Tuple2",_0: initModel,_1: $Effects.none};
   var Model = function (a) {    return {calendar: a};};
