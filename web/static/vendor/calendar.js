...
Elm.Calendar.make = function (_elm) {
   ...
   var colorOptions = function (day) {
      ...
      var _p4 = A2(httpReferences,"colors",day.date);
      var thisID = _p4._0;
      var thisRef = _p4._1;
      ...
      return _U.list([A2($Html.a,
                     ...
                     _U.list([A2($Html.a,
                             ...
                             ,A2($Html.ul,
                             _U.list([$Html$Attributes.$class("reading_list")]),
                             A2($List.map,thisColor,day.colors))]))]))]);
   };
                                                                                       ...
                                                                                       ,calendar: typeof v.calendar === "object" && v.calendar instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.calendar.map(function (v) {
                                                                                          return typeof v === "object" && "days" in v ? {_: {}
                                                                                                                                        ,days: typeof v.days === "object" && v.days instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.days.map(function (v) {
                                                                                                                                           return typeof v === "object" && "name" in v && "colors" in v && "dayOfMonth" in v && "date" in v && "daily" in v && "sunday" in v && "today" in v ? {_: {}
                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                               v.today)} : _U.badPort("an object with fields `name`, `colors`, `dayOfMonth`, `date`, `daily`, `sunday`, `today`",
                                                                                                                                           v);
                                                                                                                                        })) : _U.badPort("an array",
