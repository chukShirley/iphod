...
var _user$project$MIndex$li_button = F3(
	function (model, msg, label) {
		return A2(
			_elm_lang$html$Html$li,
			_elm_lang$core$Native_List.fromArray(
				[]),
...
var _user$project$MIndex$li_a_button = F2(
	function (ref, label) {
		return A2(
			_elm_lang$html$Html$li,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$href(ref)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
...
var _user$project$MIndex$options1 = function (model) {
	var reflection = '';
	var ep = A2(_elm_lang$core$Basics_ops['++'], '/eveningPrayer/', model.config.ps);
	var mp = A2(_elm_lang$core$Basics_ops['++'], '/morningPrayer/', model.config.ps);
	var foo = A2(_elm_lang$core$Debug$log, 'OPTIONS 1', model);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('m-options1')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$MIndex$li_a_button, mp, 'Morning Prayer'),
						A2(_user$project$MIndex$li_a_button, reflection, 'Reflection'),
						A2(_user$project$MIndex$li_a_button, ep, 'Evening Prayer')
					]))
			]));
};
...
var _user$project$MIndex$initModel = {today: '', advent: '', epiphany: '', lent: '', easter: '', pentecost: '', calendar: _user$project$Iphod_Models$dailyInit, config: _user$project$Iphod_Models$configInit};
var _user$project$MIndex$init = {ctor: '_Tuple2', _0: _user$project$MIndex$initModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$MIndex$portCalendar = _elm_lang$core$Native_Platform.incomingPort(
	'portCalendar',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'today', _elm_lang$core$Json_Decode$string),
		function (today) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_elm_lang$core$Json_Decode_ops[':='], 'advent', _elm_lang$core$Json_Decode$string),
				function (advent) {
					return A2(
						_elm_lang$core$Json_Decode$andThen,
						A2(_elm_lang$core$Json_Decode_ops[':='], 'epiphany', _elm_lang$core$Json_Decode$string),
						function (epiphany) {
							return A2(
								_elm_lang$core$Json_Decode$andThen,
								A2(_elm_lang$core$Json_Decode_ops[':='], 'lent', _elm_lang$core$Json_Decode$string),
								function (lent) {
									return A2(
										_elm_lang$core$Json_Decode$andThen,
										A2(_elm_lang$core$Json_Decode_ops[':='], 'easter', _elm_lang$core$Json_Decode$string),
										function (easter) {
											return A2(
												_elm_lang$core$Json_Decode$andThen,
												A2(_elm_lang$core$Json_Decode_ops[':='], 'pentecost', _elm_lang$core$Json_Decode$string),
												function (pentecost) {
													return A2(
														_elm_lang$core$Json_Decode$andThen,
														A2(
																																				...
																																				function (epp) {
																																					return A2(
																																						...
																																						function (show) {
																																							return A2(
																																								_elm_lang$core$Json_Decode$andThen,
																																								A2(_elm_lang$core$Json_Decode_ops[':='], 'justToday', _elm_lang$core$Json_Decode$bool),
																																								function (justToday) {
																																									return A2(
																																										_elm_lang$core$Json_Decode$andThen,
																																										A2(
																																										...
																																										function (config) {
																																											return _elm_lang$core$Json_Decode$succeed(
																																												{date: date, season: season, week: week, day: day, title: title, mp1: mp1, mp2: mp2, mpp: mpp, ep1: ep1, ep2: ep2, epp: epp, show: show, justToday: justToday, config: config});
																																										});
																																								});
																																						});
																																				});
														...
														function (calendar) {
															return A2(
																...
																function (config) {
																	return _elm_lang$core$Json_Decode$succeed(
																		{today: today, advent: advent, epiphany: epiphany, lent: lent, easter: easter, pentecost: pentecost, calendar: calendar, config: config});
																});
														});
												});
										});
...
var _user$project$MIndex$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {today: a, advent: b, epiphany: c, lent: d, easter: e, pentecost: f, calendar: g, config: h};
	});
var _user$project$MIndex$Pentecost = {ctor: 'Pentecost'};
var _user$project$MIndex$Easter = {ctor: 'Easter'};
var _user$project$MIndex$Lent = {ctor: 'Lent'};
var _user$project$MIndex$Epiphany = {ctor: 'Epiphany'};
var _user$project$MIndex$Christmas = {ctor: 'Christmas'};
var _user$project$MIndex$Advent = {ctor: 'Advent'};
var _user$project$MIndex$seasons = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('m-seasons')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A3(_user$project$MIndex$li_button, model, _user$project$MIndex$Advent, 'Advent'),
						A3(_user$project$MIndex$li_button, model, _user$project$MIndex$Christmas, 'Christmas'),
						A3(_user$project$MIndex$li_button, model, _user$project$MIndex$Epiphany, 'Epiphany'),
						A3(_user$project$MIndex$li_button, model, _user$project$MIndex$Lent, 'Lent'),
						A3(_user$project$MIndex$li_button, model, _user$project$MIndex$Easter, 'Easter'),
						A3(_user$project$MIndex$li_button, model, _user$project$MIndex$Pentecost, 'Pentecost')
					]))
			]));
};
var _user$project$MIndex$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Date Picker'),
				_user$project$MIndex$options1(model),
				_user$project$MIndex$seasons(model)
			]));
};
var _user$project$MIndex$main = {
...
var Elm = {};
Elm['MIndex'] = Elm['MIndex'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['MIndex'], 'MIndex', typeof _user$project$MIndex$main === 'undefined' ? null : _user$project$MIndex$main);
