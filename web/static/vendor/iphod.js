...
Elm.Helper.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var getText = $Signal.mailbox({ctor: "_Tuple5"
                                 ,_0: ""
                                 ,_1: ""
                                 ,_2: ""
                                 ,_3: ""
...
Elm.Iphod.Models.make = function (_elm) {
   ...
   var emailInit = {addr: "",subj: "",msg: "",show: false};
   var Email = F4(function (a,b,c,d) {
      return {addr: a,subj: b,msg: c,show: d};
   });
...
Elm.Iphod.Sunday.make = function (_elm) {
   ...
   var thisReading = F3(function (address,ofType,lessons) {
      var this_lesson = function (l) {
         var ver = _U.eq(l.section,"ps") ? "Coverdale" : "ESV";
...
Elm.Iphod.MorningPrayer.make = function (_elm) {
   ...
   var apostlesCreed = A2($Basics._op["++"],
...
Elm.Iphod = Elm.Iphod || {};
Elm.Iphod.EveningPrayer = Elm.Iphod.EveningPrayer || {};
Elm.Iphod.EveningPrayer.make = function (_elm) {
   "use strict";
   _elm.Iphod = _elm.Iphod || {};
   _elm.Iphod.EveningPrayer = _elm.Iphod.EveningPrayer || {};
   if (_elm.Iphod.EveningPrayer.values)
   return _elm.Iphod.EveningPrayer.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Helper = Elm.Helper.make(_elm),
   ...
   var openingSentences = function (model) {
      ...
      {case "advent": return A2($Basics._op["++"],
         ...
         case "lent": var os = function () {
              var _p1 = A2(cycleDay,model,3);
              switch (_p1)
              {case 0: return A2($Basics._op["++"],
                   $default("If we say we have no sin, we deceive ourselves, and the truth is not in\n                              us. If we confess our sins, he is faithful and just to forgive us our sins\n                              and to cleanse us from all unrighteousness."),
                   bibleRef("1 John 1:8-9"));
                 case 1: return A2($Basics._op["++"],
                   $default("For I know my transgressions, and my sin is ever before me."),
                   bibleRef("Psalm 51:3"));
                 default: return A2($Basics._op["++"],
                   $default("To the Lord our God belong mercy and forgiveness, for we have against him."),
                   bibleRef("Daniel 9:9"));}
           }();
           return A2($Basics._op["++"],rubricBlack("Lent"),os);
         case "goodFriday": return A2($Basics._op["++"],
           rubricBlack("Good Friday"),
           A2($Basics._op["++"],
           $default("All we like sheep have gone astray; we have turned every one to his\n                  own way; and the Lord has laid on him the iniquity of us all."),
           bibleRef("Isaiah 53:6")));
         case "easter": var os = function () {
              var _p2 = A2(cycleDay,model,2);
              if (_p2 === 0) {
                    return A2($Basics._op["++"],
                    $default("Thanks be to God, who gives us the victory through our Lord Jesus Christ."),
                    bibleRef("1 Corinthians 15:57"));
                 } else {
                    return A2($Basics._op["++"],
                    $default("If then you have been raised with Christ, seek the things that are\n                          above, where Christ is, seated at the right hand of God."),
                    bibleRef("Colossians 3:1"));
                 }
           }();
           return A2($Basics._op["++"],rubricBlack("Easter"),os);
         case "ascension": return A2($Basics._op["++"],
           rubricBlack("Ascension"),
           A2($Basics._op["++"],
         ...
         case "pentecost": var os = function () {
              var _p3 = A2(cycleDay,model,2);
              if (_p3 === 0) {
                    return A2($Basics._op["++"],
                    $default("The Spirit and the Bride say, “Come.” And let the one who hears say,\n                        “Come.” And let the one who is thirsty come; let the one who desires\n                        take the water of life without price."),
                    bibleRef("Revelation 22:17"));
                 } else {
                    return A2($Basics._op["++"],
                    $default("There is a river whose streams make glad the city of God, the holy\n                        habitation of the Most High."),
                    bibleRef("Psalm 46:4"));
                 }
           }();
           return A2($Basics._op["++"],rubricBlack("Pentecost"),os);
         case "trinity": return A2($Basics._op["++"],
           rubricBlack("Trinity Sunday"),
           A2($Basics._op["++"],
   ...
   var phosHilaron = A2($Basics._op["++"],
   A2(canticle,"Phos hilaron","O Gladsome Light"),
   A2($Basics._op["++"],
   vs("O gladsome light,"),
   A2($Basics._op["++"],
   ...
   var magnificat = A2($Basics._op["++"],
   A2(canticle,"Magnificat","The Song of Mary"),
   A2($Basics._op["++"],
   ...
   vsIndent("as it was in the beginning, is now, and ever shall be,"),
   vsIndent("world without end. Amen.")))))))))))))))))))))));
   var nuncDimittis = A2($Basics._op["++"],
   A2(canticle,"Nunc dimittis","The Song of Simeon"),
   A2($Basics._op["++"],
   ...
   var view = F2(function (address,model) {
      ...
      " ",
      $List.concat(_U.list([_U.list(["Appointed Psalms"])
                           ,A2($List.map,function (m) {    return m.body;},model.epp)])))),
      A2($Basics._op["++"],
      rubric("At the end of the Psalms is sung or said"),
      A2($Basics._op["++"],
      vs("Glory to the Father, and to the Son, and to the Holy Spirit;"),
      ...
      " ",
      $List.concat(_U.list([_U.list(["The First Lesson from"])
                           ,A2($List.map,function (m) {    return m.body;},model.ep1)])))),
      A2($Basics._op["++"],
      rubric("A citation giving chapter and verse may be added."),
      A2($Basics._op["++"],
      rubric("After each Lesson the Reader may say"),
      ...
      " ",
      $List.concat(_U.list([_U.list(["The Second Lesson from"])
                           ,A2($List.map,function (m) {    return m.body;},model.ep2)])))),
      A2($Basics._op["++"],
      theWordOfTheLord,
      A2($Basics._op["++"],
      blankline,
   ...
   var NoOp = {ctor: "NoOp"};
   var init = $Iphod$Models.dailyInit;
   return _elm.Iphod.EveningPrayer.values = {_op: _op
                                            ,init: init
                                            ,update: update
                                            ,view: view};
};
...
Elm.Iphod.Daily.make = function (_elm) {
         ...
         default: var _p4 = _p1._0;
           ...
           var newModel = function () {
              ...
              {case "mp1": return _U.update(model,{mp1: newSection});
                 ...
                 case "mpp": return _U.update(model,{mpp: newSection});
   ...
   var thisReading = F2(function (address,lessons) {
      var this_lesson = function (l) {
         var ver = _U.eq(l.section,"mpp") || _U.eq(l.section,
         "epp") ? "Coverdale" : "ESV";
         return _U.eq($String.length(l.body),0) ? A2($Html.li,
         hoverable(_U.list([this_style(l)
                           ,A2($Html$Events.onClick,
...
Elm.Iphod.Email.make = function (_elm) {
   ...
   var buttonStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                    ...
                                                    ,{ctor: "_Tuple2",_0: "display",_1: "inline-block"}]));
   var msgAddrStyle = function (model) {
      return $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                             ,_0: "width"
                                             ,_1: "45em"}
                                            ,{ctor: "_Tuple2",_0: "height",_1: "5em"}
                                            ,{ctor: "_Tuple2",_0: "margin-left",_1: "1em"}
                                            ,{ctor: "_Tuple2",_0: "padding-left",_1: "1em"}]));
   };
   var subjectStyle = function (model) {
      return $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                             ,_0: "width"
                                             ,_1: "45em"}
                                            ,{ctor: "_Tuple2",_0: "margin-left",_1: "1em"}
   ...
   var emailAddrStyle = function (model) {
      return $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                             ,_0: "width"
                                             ,_1: "20em"}
                                            ,{ctor: "_Tuple2",_0: "margin-left",_1: "1em"}
   ...
   var contactStyle = function (model) {
      ...
      _U.list([{ctor: "_Tuple2",_0: "position",_1: "absolute"}
              ...
              ,{ctor: "_Tuple2",_0: "width",_1: "50em"}
              ,{ctor: "_Tuple2",_0: "margin-top",_1: "0.5em"}
              ,{ctor: "_Tuple2",_0: "border",_1: "2px solid darkblue"}
              ,{ctor: "_Tuple2",_0: "border-radius",_1: "0.5em"}
              ,{ctor: "_Tuple2",_0: "background-color",_1: "linen"}]));
   };
   var Message = function (a) {
      return {ctor: "Message",_0: a};
   };
   ...
   var inputEmailAddress = F2(function (address,model) {
      ...
      _U.list([$Html$Attributes.id("addr")
              ...
              ,$Html$Attributes.value(model.addr)
   ...
   var inputSubject = F2(function (address,model) {
      ...
      _U.list([]),
      _U.list([A2($Html.input,
      _U.list([$Html$Attributes.id("subj")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("Subject - required")
              ,$Html$Attributes.autofocus(true)
              ,$Html$Attributes.name("subj")
              ,A3($Html$Events.on,
              "input",
              $Html$Events.targetValue,
              function (str) {
              ...
              ,A2($Helper.onClickLimited,address,NoOp)
              ,$Html$Attributes.value(model.subj)
              ,subjectStyle(model)]),
      _U.list([]))]));
   });
   var inputMessage = F2(function (address,model) {
      ...
      _U.list([$Html$Attributes.id("msg")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("Enter Message - required")
              ,$Html$Attributes.autofocus(true)
              ,$Html$Attributes.name("msg")
              ,A3($Html$Events.on,
              "input",
              $Html$Events.targetValue,
              function (str) {
              ...
              ,A2($Helper.onClickLimited,address,NoOp)
              ,$Html$Attributes.value(model.msg)
              ,msgAddrStyle(model)]),
      _U.list([]))]));
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([contactStyle(model)]),
      _U.list([A2(inputEmailAddress,address,model)
              ,A2(inputSubject,address,model)
              ,A2(inputMessage,address,model)
              ,A2($Html.button,
              _U.list([buttonStyle,A2($Html$Events.onClick,address,Send)]),
              _U.list([$Html.text("Send")]))
              ,A2($Html.button,
              _U.list([buttonStyle,A2($Html$Events.onClick,address,Clear)]),
              _U.list([$Html.text("Clear")]))
              ,A2($Html.button,
              _U.list([buttonStyle,A2($Html$Events.onClick,address,Cancel)]),
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         case "Send": var foo = A2($Debug.log,"EMAIL",model);
           return model;
         case "Clear": return _U.update(model,{msg: ""});
         case "Cancel": return init;
         case "EmailAddress": return _U.update(model,{addr: _p0._0});
         default: return _U.update(model,{msg: _p0._0});}
   });
   return _elm.Iphod.Email.values = {_op: _op
                                    ...
                                    ,emailAddrStyle: emailAddrStyle
                                    ,subjectStyle: subjectStyle
                                    ,msgAddrStyle: msgAddrStyle
...
Elm.Iphod.make = function (_elm) {
   ...
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $Iphod$Config = Elm.Iphod.Config.make(_elm),
   ...
   var aboutButtonStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                          ,_0: "position"
                                                          ,_1: "relative"}
   ...
   var listDates = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("list_dates")]),
      _U.list([A2($Html.ul,
      _U.list([$Html$Attributes.$class("list_dates")]),
      _U.list([A2($Html.li,
              _U.list([]),
   ...
   var updateDailyText = F2(function (daily,text) {
      ...
      var this_section = function () {
         ...
         {case "mp1": return daily.mp1;
            ...
            case "mpp": return daily.mpp;
            case "ep1": return daily.ep1;
            case "ep2": return daily.ep2;
            case "epp": return daily.epp;
            default: return daily.epp;}
      }();
      var newSection = A2($List.map,update_text,this_section);
      var newDaily = function () {
         ...
         {case "mp1": return _U.update(daily,{mp1: newSection});
            ...
            case "mpp": return _U.update(daily,{mpp: newSection});
            case "ep1": return _U.update(daily,{ep1: newSection});
            case "ep2": return _U.update(daily,{ep2: newSection});
            case "epp": return _U.update(daily,{epp: newSection});
            default: return _U.update(daily,{epp: newSection});}
      }();
      return newDaily;
   });
   ...
   var ModConfig = F2(function (a,b) {
      return {ctor: "ModConfig",_0: a,_1: b};
   });
   ...
   var listReadings = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("list_readings")
              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                               ,_0: "margin-top"
                                               ,_1: "0em"}
                                              ,{ctor: "_Tuple2",_0: "z-index",_1: "99"}]))]),
      _U.list([A2($Iphod$Daily.view,
   ...
   var eveningPrayerDiv = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Iphod$EveningPrayer.view,
      A2($Signal.forwardTo,address,ModEP(model.eveningPrayer)),
      model.eveningPrayer)]));
   });
   ...
   var ModEmail = F2(function (a,b) {
      return {ctor: "ModEmail",_0: a,_1: b};
   });
   var emailMe = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Iphod$Email.view,
      A2($Signal.forwardTo,address,ModEmail(model.email)),
      model.email)]));
   });
   ...
   var readingNav = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("menu3")
   ...
   var ToggleEp = {ctor: "ToggleEp"};
   var ToggleMp = {ctor: "ToggleMp"};
   var ToggleEmail = {ctor: "ToggleEmail"};
   ...
   "Iphod.NewText",
   function (v) {
      return typeof v === "object" && "model" in v && "section" in v && "id" in v && "body" in v && "version" in v ? {_: {}
                                                                                                                     ...
                                                                                                                     v.version)} : _U.badPort("an object with fields `model`, `section`, `id`, `body`, `version`",
      v);
   });
   var nextSunday = Elm.Native.Port.make(_elm).inboundSignal("nextSunday",
   "Iphod.Model",
   function (v) {
      return typeof v === "object" && "today" in v && "sunday" in v && "redLetter" in v && "daily" in v && "morningPrayer" in v && "eveningPrayer" in v && "email" in v && "config" in v && "about" in v ? {_: {}
                                                                                                                                                                                                           ,today: typeof v.today === "string" || typeof v.today === "object" && v.today instanceof String ? v.today : _U.badPort("a string",
                                                                                                                                                                                                           v.today)
                                                                                                                                                                                                           ,sunday: typeof v.sunday === "object" && "ofType" in v.sunday && "date" in v.sunday && "season" in v.sunday && "week" in v.sunday && "title" in v.sunday && "ot" in v.sunday && "ps" in v.sunday && "nt" in v.sunday && "gs" in v.sunday && "show" in v.sunday ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            v.sunday.show)} : _U.badPort("an object with fields `ofType`, `date`, `season`, `week`, `title`, `ot`, `ps`, `nt`, `gs`, `show`",
                                                                                                                                                                                                           v.sunday)
                                                                                                                                                                                                           ,redLetter: typeof v.redLetter === "object" && "ofType" in v.redLetter && "date" in v.redLetter && "season" in v.redLetter && "week" in v.redLetter && "title" in v.redLetter && "ot" in v.redLetter && "ps" in v.redLetter && "nt" in v.redLetter && "gs" in v.redLetter && "show" in v.redLetter ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                v.redLetter.show)} : _U.badPort("an object with fields `ofType`, `date`, `season`, `week`, `title`, `ot`, `ps`, `nt`, `gs`, `show`",
                                                                                                                                                                                                           v.redLetter)
                                                                                                                                                                                                           ,daily: typeof v.daily === "object" && "date" in v.daily && "season" in v.daily && "week" in v.daily && "day" in v.daily && "title" in v.daily && "mp1" in v.daily && "mp2" in v.daily && "mpp" in v.daily && "ep1" in v.daily && "ep2" in v.daily && "epp" in v.daily && "show" in v.daily && "justToday" in v.daily ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   v.daily.mp2)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ,mpp: typeof v.daily.mpp === "object" && v.daily.mpp instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.daily.mpp.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   v.daily.ep2)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ,epp: typeof v.daily.epp === "object" && v.daily.epp instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.daily.epp.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   v.daily.justToday)} : _U.badPort("an object with fields `date`, `season`, `week`, `day`, `title`, `mp1`, `mp2`, `mpp`, `ep1`, `ep2`, `epp`, `show`, `justToday`",
                                                                                                                                                                                                           v.daily)
                                                                                                                                                                                                           ,morningPrayer: typeof v.morningPrayer === "object" && "date" in v.morningPrayer && "season" in v.morningPrayer && "week" in v.morningPrayer && "day" in v.morningPrayer && "title" in v.morningPrayer && "mp1" in v.morningPrayer && "mp2" in v.morningPrayer && "mpp" in v.morningPrayer && "ep1" in v.morningPrayer && "ep2" in v.morningPrayer && "epp" in v.morningPrayer && "show" in v.morningPrayer && "justToday" in v.morningPrayer ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,date: typeof v.morningPrayer.date === "string" || typeof v.morningPrayer.date === "object" && v.morningPrayer.date instanceof String ? v.morningPrayer.date : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.morningPrayer.date)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,season: typeof v.morningPrayer.season === "string" || typeof v.morningPrayer.season === "object" && v.morningPrayer.season instanceof String ? v.morningPrayer.season : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.morningPrayer.season)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,week: typeof v.morningPrayer.week === "string" || typeof v.morningPrayer.week === "object" && v.morningPrayer.week instanceof String ? v.morningPrayer.week : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.morningPrayer.week)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,day: typeof v.morningPrayer.day === "string" || typeof v.morningPrayer.day === "object" && v.morningPrayer.day instanceof String ? v.morningPrayer.day : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.morningPrayer.day)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,title: typeof v.morningPrayer.title === "string" || typeof v.morningPrayer.title === "object" && v.morningPrayer.title instanceof String ? v.morningPrayer.title : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.morningPrayer.title)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,mp1: typeof v.morningPrayer.mp1 === "object" && v.morningPrayer.mp1 instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.morningPrayer.mp1.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.morningPrayer.mp1)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,mp2: typeof v.morningPrayer.mp2 === "object" && v.morningPrayer.mp2 instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.morningPrayer.mp2.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.morningPrayer.mp2)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,mpp: typeof v.morningPrayer.mpp === "object" && v.morningPrayer.mpp instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.morningPrayer.mpp.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.morningPrayer.mpp)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,ep1: typeof v.morningPrayer.ep1 === "object" && v.morningPrayer.ep1 instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.morningPrayer.ep1.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.morningPrayer.ep1)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,ep2: typeof v.morningPrayer.ep2 === "object" && v.morningPrayer.ep2 instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.morningPrayer.ep2.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.morningPrayer.ep2)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,epp: typeof v.morningPrayer.epp === "object" && v.morningPrayer.epp instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.morningPrayer.epp.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.morningPrayer.epp)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.morningPrayer.show === "boolean" ? v.morningPrayer.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.morningPrayer.justToday)} : _U.badPort("an object with fields `date`, `season`, `week`, `day`, `title`, `mp1`, `mp2`, `mpp`, `ep1`, `ep2`, `epp`, `show`, `justToday`",
                                                                                                                                                                                                           v.morningPrayer)
                                                                                                                                                                                                           ,eveningPrayer: typeof v.eveningPrayer === "object" && "date" in v.eveningPrayer && "season" in v.eveningPrayer && "week" in v.eveningPrayer && "day" in v.eveningPrayer && "title" in v.eveningPrayer && "mp1" in v.eveningPrayer && "mp2" in v.eveningPrayer && "mpp" in v.eveningPrayer && "ep1" in v.eveningPrayer && "ep2" in v.eveningPrayer && "epp" in v.eveningPrayer && "show" in v.eveningPrayer && "justToday" in v.eveningPrayer ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,date: typeof v.eveningPrayer.date === "string" || typeof v.eveningPrayer.date === "object" && v.eveningPrayer.date instanceof String ? v.eveningPrayer.date : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.eveningPrayer.date)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,season: typeof v.eveningPrayer.season === "string" || typeof v.eveningPrayer.season === "object" && v.eveningPrayer.season instanceof String ? v.eveningPrayer.season : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.eveningPrayer.season)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,week: typeof v.eveningPrayer.week === "string" || typeof v.eveningPrayer.week === "object" && v.eveningPrayer.week instanceof String ? v.eveningPrayer.week : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.eveningPrayer.week)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,day: typeof v.eveningPrayer.day === "string" || typeof v.eveningPrayer.day === "object" && v.eveningPrayer.day instanceof String ? v.eveningPrayer.day : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.eveningPrayer.day)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,title: typeof v.eveningPrayer.title === "string" || typeof v.eveningPrayer.title === "object" && v.eveningPrayer.title instanceof String ? v.eveningPrayer.title : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.eveningPrayer.title)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,mp1: typeof v.eveningPrayer.mp1 === "object" && v.eveningPrayer.mp1 instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.eveningPrayer.mp1.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.eveningPrayer.mp1)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,mp2: typeof v.eveningPrayer.mp2 === "object" && v.eveningPrayer.mp2 instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.eveningPrayer.mp2.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.eveningPrayer.mp2)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,mpp: typeof v.eveningPrayer.mpp === "object" && v.eveningPrayer.mpp instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.eveningPrayer.mpp.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.eveningPrayer.mpp)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,ep1: typeof v.eveningPrayer.ep1 === "object" && v.eveningPrayer.ep1 instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.eveningPrayer.ep1.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.eveningPrayer.ep1)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,ep2: typeof v.eveningPrayer.ep2 === "object" && v.eveningPrayer.ep2 instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.eveningPrayer.ep2.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.eveningPrayer.ep2)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,epp: typeof v.eveningPrayer.epp === "object" && v.eveningPrayer.epp instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.eveningPrayer.epp.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return typeof v === "object" && "style" in v && "show" in v && "read" in v && "body" in v && "id" in v && "section" in v && "version" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,style: typeof v.style === "string" || typeof v.style === "object" && v.style instanceof String ? v.style : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.style)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.eveningPrayer.epp)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,show: typeof v.eveningPrayer.show === "boolean" ? v.eveningPrayer.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.eveningPrayer.justToday)} : _U.badPort("an object with fields `date`, `season`, `week`, `day`, `title`, `mp1`, `mp2`, `mpp`, `ep1`, `ep2`, `epp`, `show`, `justToday`",
                                                                                                                                                                                                           v.eveningPrayer)
                                                                                                                                                                                                           ,email: typeof v.email === "object" && "addr" in v.email && "subj" in v.email && "msg" in v.email && "show" in v.email ? {_: {}
                                                                                                                                                                                                                                                                                                                                    ,addr: typeof v.email.addr === "string" || typeof v.email.addr === "object" && v.email.addr instanceof String ? v.email.addr : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                    v.email.addr)
                                                                                                                                                                                                                                                                                                                                    ,subj: typeof v.email.subj === "string" || typeof v.email.subj === "object" && v.email.subj instanceof String ? v.email.subj : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                    v.email.subj)
                                                                                                                                                                                                                                                                                                                                    ,msg: typeof v.email.msg === "string" || typeof v.email.msg === "object" && v.email.msg instanceof String ? v.email.msg : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                    v.email.msg)
                                                                                                                                                                                                                                                                                                                                    ,show: typeof v.email.show === "boolean" ? v.email.show : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                    v.email.show)} : _U.badPort("an object with fields `addr`, `subj`, `msg`, `show`",
                                                                                                                                                                                                           v.email)
                                                                                                                                                                                                           ,config: typeof v.config === "object" && "ot" in v.config && "ps" in v.config && "nt" in v.config && "gs" in v.config && "fnotes" in v.config ? {_: {}
                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                           v.config.gs)
                                                                                                                                                                                                                                                                                                                                                           ,fnotes: typeof v.config.fnotes === "boolean" ? v.config.fnotes : _U.badPort("a boolean (true or false)",
   ...
   var gatherText = F2(function (model,prayer) {
      ...
      {ctor: "_Tuple2",_0: prayer,_1: model.today}))));
   });
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2(fancyNav,address,model)
              ...
              ,A2(eveningPrayerDiv,address,model)]));
   });
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return {ctor: "_Tuple2"
         ...
         case "ToggleMp": var mp = model.morningPrayer;
           ...
           var effect = newmp.show ? A2(gatherText,
           model,
           "morningPrayer") : $Effects.none;
           return {ctor: "_Tuple2",_0: newModel,_1: effect};
         case "ToggleEp": var ep = model.eveningPrayer;
           var newep = _U.update(ep,{show: $Basics.not(ep.show)});
           var newModel = _U.update(model,{eveningPrayer: newep});
           var effect = newep.show ? A2(gatherText,
           model,
           "eveningPrayer") : $Effects.none;
           return {ctor: "_Tuple2",_0: newModel,_1: effect};
         ...
         case "UpdateText": var _p6 = _p4._0;
           var newModel = function () {
              ...
              {case "sunday": return _U.update(model,
                 ...
                 case "eveningPrayer": return _U.update(model,
                   {eveningPrayer: A2(updateDailyText,model.eveningPrayer,_p6)});
         ...
         case "ModEP": var newModel = A2($Iphod$EveningPrayer.update,
           _p4._1,
           _p4._0);
           return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "ModSunday": var _p9 = _p4._1;
           ...
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "ModDaily": var newModel = _U.update(model,
           {daily: A2($Iphod$Daily.update,_p4._1,_p4._0)});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "ModEmail": var newModel = _U.update(model,
           {email: A2($Iphod$Email.update,_p4._1,_p4._0)});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         default: var newModel = _U.update(model,
           {config: A2($Iphod$Config.update,_p4._1,_p4._0)});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};}
   });
   var incomingText = A2($Signal.map,UpdateText,newText);
   var incomingActions = A2($Signal.map,SetSunday,nextSunday);
   var initModel = {today: ""
                   ,sunday: $Iphod$Models.sundayInit
                   ,redLetter: $Iphod$Models.sundayInit
                   ,daily: $Iphod$Models.dailyInit
                   ,morningPrayer: $Iphod$Models.dailyInit
                   ,eveningPrayer: $Iphod$Models.dailyInit
                   ,email: $Iphod$Models.emailInit
                   ,config: $Iphod$Models.configInit
                   ,about: false};
   ...
   var NewText = F5(function (a,b,c,d,e) {
      return {model: a,section: b,id: c,body: d,version: e};
   });
