...
Elm.Iphod.Email.make = function (_elm) {
   ...
   var init = {addr: "",subj: "",msg: "",show: false};
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "NoOp": return model;
...
Elm.Iphod.make = function (_elm) {
   ...
   "Iphod.Model",
   function (v) {
      return typeof v === "object" && "today" in v && "sunday" in v && "redLetter" in v && "daily" in v && "morningPrayer" in v && "eveningPrayer" in v && "email" in v && "about" in v ? {_: {}
                                                                                                                                                                                          ...
                                                                                                                                                                                          v.about)} : _U.badPort("an object with fields `today`, `sunday`, `redLetter`, `daily`, `morningPrayer`, `eveningPrayer`, `email`, `about`",
      v);
   });
   ...
   var initModel = {today: ""
                   ...
                   ,daily: $Iphod$Daily.init
                   ,morningPrayer: $Iphod$MorningPrayer.init
                   ,email: $Iphod$Email.init
                   ,about: false
                   ,eveningPrayer: $Iphod$EveningPrayer.init};
