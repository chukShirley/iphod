...
Elm.Iphod.make = function (_elm) {
   ...
   "Iphod.Model",
   function (v) {
      return typeof v === "object" && "today" in v && "sunday" in v && "redLetter" in v && "daily" in v && "morningPrayer" in v && "eveningPrayer" in v && "about" in v ? {_: {}
                                                                                                                                                                          ...
                                                                                                                                                                          v.about)} : _U.badPort("an object with fields `today`, `sunday`, `redLetter`, `daily`, `morningPrayer`, `eveningPrayer`, `about`",
      v);
   });
