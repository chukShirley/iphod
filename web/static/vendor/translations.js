...
Elm.Translations.make = function (_elm) {
   "use strict";
   _elm.Translations = _elm.Translations || {};
   if (_elm.Translations.values) return _elm.Translations.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var versionRow = function (model) {
      var this_style = _U.list([model.selected ? {ctor: "_Tuple2"
                                                 ,_0: "background-color"
   ...
   var AddModel = function (a) {
      return {ctor: "AddModel",_0: a};
   };
   var NoOp = {ctor: "NoOp"};
   var findVersion = function (address) {
      return A2($Html.th,
      _U.list([]),
      _U.list([A2($Html.input,
      _U.list([$Html$Attributes.id("find_version")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("Version")
              ,$Html$Attributes.autofocus(true)
              ,$Html$Attributes.name("find_version")
              ,A3($Html$Events.on,
              "keyup",
   ...
   var findName = function (address) {
      return A2($Html.th,
      _U.list([]),
      _U.list([A2($Html.input,
      _U.list([$Html$Attributes.id("find_name")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("Version Name")
              ,$Html$Attributes.autofocus(true)
              ,$Html$Attributes.name("find_name")
              ,A3($Html$Events.on,
              "keyup",
              $Html$Events.targetValue,
              function (str) {
   ...
   var findLanguage = function (address) {
      return A2($Html.th,
      _U.list([]),
      _U.list([A2($Html.input,
      _U.list([$Html$Attributes.id("find_lang")
              ,$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("Language")
              ,$Html$Attributes.autofocus(true)
              ,$Html$Attributes.name("find_lang")
              ,A3($Html$Events.on,
              "keyup",
              $Html$Events.targetValue,
              function (str) {
   ...
   var view = F2(function (address,model) {
      var this_version = function (ver) {
         ...
         return A2($Html.tr,
         _U.list([versionRow(ver)]),
         _U.list([A2($Html.td,
                 _U.list([$Html$Attributes.$class("ver_abbr")]),
                 _U.list([$Html.text(ver.abbr)]))
                 ,A2($Html.td,
                 _U.list([$Html$Attributes.$class("ver_name")]),
                 _U.list([$Html.text(ver.name)]))
                 ,A2($Html.td,
      ...
      _U.list([A2($Html.h1,
              _U.list([]),
              _U.list([$Html.text("Select Versions")]))
              ,A2($Html.table,
              _U.list([$Html$Attributes.$class("versions")]),
              _U.list([A2($Html.thead,
                      ...
                      _U.list([A2($Html.tr,
                              ...
                              _U.list([A2($Html.th,
                                      ...
                                      ,A2($Html.th,
                                      _U.list([$Html$Attributes.$class("ver_name")]),
                                      _U.list([$Html.text("Version Name")]))
                                      ,A2($Html.th,
                                      _U.list([$Html$Attributes.$class("ver_language")]),
                                      _U.list([$Html.text("Language")]))
                                      ,A2($Html.th,
                                      _U.list([$Html$Attributes.$class("ver_use")]),
                                      _U.list([$Html.text("Select")]))]))
                              ,A2($Html.tr,
                              _U.list([]),
                              _U.list([findVersion(address)
                                      ,findName(address)
                      ...
                      ,A2($Html.tbody,
                      _U.list([]),
                      A2($List.map,this_version,model))]))]));
   });
   var allVersions = Elm.Native.Port.make(_elm).inboundSignal("allVersions",
   "Translations.Model",
   function (v) {
      return typeof v === "object" && v instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
         return typeof v === "object" && "id" in v && "abbr" in v && "name" in v && "lang" in v && "show" in v && "selected" in v ? {_: {}
                                                                                                                                    ,id: typeof v.id === "string" || typeof v.id === "object" && v.id instanceof String ? v.id : _U.badPort("a string",
                                                                                                                                    v.id)
                                                                                                                                    ,abbr: typeof v.abbr === "string" || typeof v.abbr === "object" && v.abbr instanceof String ? v.abbr : _U.badPort("a string",
                                                                                                                                    v.abbr)
                                                                                                                                    ,name: typeof v.name === "string" || typeof v.name === "object" && v.name instanceof String ? v.name : _U.badPort("a string",
                                                                                                                                    v.name)
                                                                                                                                    ,lang: typeof v.lang === "string" || typeof v.lang === "object" && v.lang instanceof String ? v.lang : _U.badPort("a string",
                                                                                                                                    v.lang)
                                                                                                                                    ,show: typeof v.show === "boolean" ? v.show : _U.badPort("a boolean (true or false)",
                                                                                                                                    v.show)
                                                                                                                                    ,selected: typeof v.selected === "boolean" ? v.selected : _U.badPort("a boolean (true or false)",
                                                                                                                                    v.selected)} : _U.badPort("an object with fields `id`, `abbr`, `name`, `lang`, `show`, `selected`",
         v);
      })) : _U.badPort("an array",v);
   });
   var incomingVersion = A2($Signal.map,AddModel,allVersions);
   ...
   var app = $StartApp.start({init: init
                             ,update: update
                             ,view: view
                             ,inputs: _U.list([incomingVersion])});
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",
   app.tasks);
   return _elm.Translations.values = {_op: _op
                                     ,app: app
                                     ,main: main
                                     ,Version: Version
