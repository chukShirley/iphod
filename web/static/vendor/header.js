...
Elm.Header.make = function (_elm) {
   ...
   var howToModal = A2($Html.span,
   _U.list([]),
   _U.list([A2($Html.a,
           _U.list([$Html$Attributes.href("#howTo-text")]),
           _U.list([A2($Html.button,
           _U.list([]),
           _U.list([$Html.text("How to Use")]))]))
           ,A2($Html.div,
           _U.list([$Html$Attributes.id("howTo-text")
                   ,$Html$Attributes.$class("modalDialog")]),
           _U.list([A2($Html.div,
           _U.list([]),
           _U.list([A2($Html.a,
                   _U.list([$Html$Attributes.href("#closehowTo-text")
                   ...
                   ,A2($Html.p,
                   _U.list([]),
                   _U.list([$Markdown.toHtml(howToUse)]))]))]))]));
   var aboutModal = A2($Html.span,
   _U.list([]),
   _U.list([A2($Html.a,
           _U.list([$Html$Attributes.href("#about-text")]),
           _U.list([A2($Html.button,
           _U.list([]),
           _U.list([$Html.text("About")]))]))
           ,A2($Html.div,
           _U.list([$Html$Attributes.id("about-text")
                   ,$Html$Attributes.$class("modalDialog")]),
           _U.list([A2($Html.div,
           _U.list([]),
           _U.list([A2($Html.a,
                   _U.list([$Html$Attributes.href("#closeabout-text")
                           ,$Html$Attributes.title("Close")
                           ,$Html$Attributes.$class("close")]),
                   _U.list([$Html.text("X")]))
                   ,A2($Html.h2,
   ...
   var configModal = F2(function (address,model) {
      return A2($Html.span,
      _U.list([]),
      _U.list([A2($Html.a,
              _U.list([$Html$Attributes.href("#config-text")]),
              _U.list([A2($Html.button,
              _U.list([]),
              _U.list([$Html.text("Config")]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.id("config-text")
                      ,$Html$Attributes.$class("configModalDialog")]),
              _U.list([A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.a,
                      _U.list([$Html$Attributes.href("#closeconfig-text")
                              ,$Html$Attributes.title("Close")
                              ,$Html$Attributes.$class("close")]),
                      _U.list([$Html.text("X")]))
                      ,A2($Html.h2,
   ...
   var newHeader = Elm.Native.Port.make(_elm).inboundSignal("newHeader",
   "Header.Model",
   function (v) {
      return typeof v === "object" && "email" in v && "config" in v ? {_: {}
   ...
   var sendContactMe = $Signal.mailbox($Iphod$Models.emailInit);
   ...
   var emailMe = F2(function (address,model) {
      ...
      _U.list([]),
      _U.list([A2($Html.a,
              _U.list([$Html$Attributes.href("#email-create")]),
              _U.list([A2($Html.button,
              _U.list([]),
              _U.list([$Html.text("Contact")]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.id("email-create")
                      ,$Html$Attributes.$class("emailModalDialog")]),
              _U.list([A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.a,
                      _U.list([$Html$Attributes.href("#closeemail-create")
                              ,$Html$Attributes.title("Close")
                              ,$Html$Attributes.$class("close")]),
                      _U.list([$Html.text("X")]))
                      ,A2($Html.h2,
                      _U.list([$Html$Attributes.$class("modal_header")]),
                      _U.list([$Html.text("Contact")]))
                      ,A2(inputEmailAddress,address,model.email)
                      ,A2(inputSubject,address,model.email)
                      ,A2(inputMessage,address,model.email)
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("email-button")
                              ,A2($Html$Events.onClick,sendContactMe.address,model.email)]),
   ...
   var view = F2(function (address,model) {
      return A2($Html.ul,
      _U.list([$Html$Attributes.id("header-options")]),
      _U.list([A2($Html.li,
              _U.list([$Html$Attributes.$class("option-item")]),
              _U.list([howToModal]))
              ,A2($Html.li,
              _U.list([$Html$Attributes.$class("option-item")]),
              _U.list([A2(configModal,address,model)]))
              ,A2($Html.li,
              _U.list([$Html$Attributes.$class("option-item")]),
              _U.list([A2(emailMe,address,model)]))
              ,A2($Html.li,
              _U.list([$Html$Attributes.$class("option-item")]),
              _U.list([aboutModal]))]));
   });
   ...
   var saveConfig = function (config) {
      ...
      $Basics.always(NoOp),
      $Task.toMaybe(A2($Signal.send,saveThisConfig.address,config))));
   };
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "NoOp": return {ctor: "_Tuple2"
                           ,_0: model
                           ,_1: $Effects.none};
         case "Send": return {ctor: "_Tuple2"
                             ,_0: model
                             ,_1: $Effects.none};
         case "Clear": var e = model.email;
           var newEmail = _U.update(e,{text: ""});
         ...
         case "UpdateEmail": return {ctor: "_Tuple2"
                                    ...
                                    ,_1: $Effects.none};
         case "EmailAddress": var e = model.email;
           var newEmail = _U.update(e,{from: _p0._0});
           var newModel = _U.update(model,{email: newEmail});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "Topic": var e = model.email;
           var newEmail = _U.update(e,{topic: _p0._0});
           var newModel = _U.update(model,{email: newEmail});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "Message": var e = model.email;
