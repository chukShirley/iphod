...
Elm.Iphod.make = function (_elm) {
   ...
   function (v) {
      return typeof v === "object" && "today" in v && "sunday" in v && "redLetter" in v && "daily" in v && "morningPrayer" in v && "about" in v ? {_: {}
                                                                                                                                                  ...
                                                                                                                                                  v.daily)
                                                                                                                                                  ,morningPrayer: typeof v.morningPrayer === "object" && "date" in v.morningPrayer && "season" in v.morningPrayer && "week" in v.morningPrayer && "day" in v.morningPrayer && "title" in v.morningPrayer && "mp1" in v.morningPrayer && "mp2" in v.morningPrayer && "ep1" in v.morningPrayer && "ep2" in v.morningPrayer && "show" in v.morningPrayer && "justToday" in v.morningPrayer ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          v.morningPrayer.justToday)} : _U.badPort("an object with fields `date`, `season`, `week`, `day`, `title`, `mp1`, `mp2`, `ep1`, `ep2`, `show`, `justToday`",
                                                                                                                                                  v.morningPrayer)
