...
Elm.Iphod.make = function (_elm) {
   ...
   var esvTextStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                      ,_0: "font-size"
                                                      ,_1: "0.8em"}]));
   var readingTitleStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                           ,_0: "font-size"
                                                           ,_1: "0.8em"}
   ...
   function (v) {
      return typeof v === "object" && "sunday" in v && "nextFeastDay" in v && "today" in v ? {_: {}
                                                                                             ...
                                                                                             v.sunday)
                                                                                             ,nextFeastDay: typeof v.nextFeastDay === "object" && "ofType" in v.nextFeastDay && "date" in v.nextFeastDay && "season" in v.nextFeastDay && "week" in v.nextFeastDay && "title" in v.nextFeastDay && "ot" in v.nextFeastDay && "ps" in v.nextFeastDay && "nt" in v.nextFeastDay && "gs" in v.nextFeastDay ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                          ,ofType: typeof v.nextFeastDay.ofType === "string" || typeof v.nextFeastDay.ofType === "object" && v.nextFeastDay.ofType instanceof String ? v.nextFeastDay.ofType : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                          v.nextFeastDay.ofType)
                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                          v.nextFeastDay.gs)} : _U.badPort("an object with fields `ofType`, `date`, `season`, `week`, `title`, `ot`, `ps`, `nt`, `gs`",
                                                                                             v.nextFeastDay)
   ...
   var getText = $Signal.mailbox({ctor: "_Tuple2"
                                 ,_0: ""
                                 ,_1: _U.list([])});
   ...
   var theseReadings = F2(function (address,readings) {
      var esv = $Html$Attributes.$class("esv_text");
      ...
      return _U.list([A2($Html.li,
                     ...
                     ,A2($Html.li,
                     _U.list([readingTitleStyle
                             ,A2($Html$Events.onClick,
                             getText.address,
                             {ctor: "_Tuple2",_0: named("ot"),_1: readings.ot})]),
                     _U.list([$Html.text(A2($Basics._op["++"],
                     "OT: ",
                     readingList(readings.ot)))]))
                     ,A2($Html.li,
                     _U.list([$Html$Attributes.id(named("ot")),esv,esvTextStyle]),
                     _U.list([$Html.text("")]))
                     ,A2($Html.li,
                     _U.list([readingTitleStyle
                             ,A2($Html$Events.onClick,
                             getText.address,
                             {ctor: "_Tuple2",_0: named("ps"),_1: readings.ps})]),
                     _U.list([$Html.text(A2($Basics._op["++"],
                     "PS: ",
                     readingList(readings.ps)))]))
                     ,A2($Html.li,
                     _U.list([$Html$Attributes.id(named("ps")),esv,esvTextStyle]),
                     _U.list([$Html.text("")]))
                     ,A2($Html.li,
                     _U.list([readingTitleStyle
                             ,A2($Html$Events.onClick,
                             getText.address,
                             {ctor: "_Tuple2",_0: named("nt"),_1: readings.nt})]),
                     _U.list([$Html.text(A2($Basics._op["++"],
                     "NT: ",
                     readingList(readings.nt)))]))
                     ,A2($Html.li,
                     _U.list([$Html$Attributes.id(named("nt")),esv,esvTextStyle]),
                     _U.list([$Html.text("")]))
                     ,A2($Html.li,
                     _U.list([readingTitleStyle
                             ,A2($Html$Events.onClick,
                             getText.address,
                             {ctor: "_Tuple2",_0: named("gs"),_1: readings.gs})]),
                     _U.list([$Html.text(A2($Basics._op["++"],
                     "GS: ",
                     readingList(readings.gs)))]))
                     ,A2($Html.li,
                     _U.list([$Html$Attributes.id(named("gs")),esv,esvTextStyle]),
                     _U.list([$Html.text("")]))]);
   });
   ...
   var Readings = F9(function (a,b,c,d,e,f,g,h,i) {
      return {ofType: a
             ,date: b
             ,season: c
             ,week: d
   ...
   var initEsvText = {reading: "",body: ""};
   var EsvText = F2(function (a,b) {
      return {reading: a,body: b};
   });
   ...
   return _elm.Iphod.values = {_op: _op
                              ...
                              ,readingTitleStyle: readingTitleStyle
                              ,esvTextStyle: esvTextStyle
...
channel.on('nextSundayReadings', function (data) {
  elmApp.ports.nextSundayReadings.send(data);
});

channel.on('esv_text', function (data) {
