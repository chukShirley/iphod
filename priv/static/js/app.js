...
Elm.Iphod.make = function (_elm) {
   ...
   "Iphod.Model",
   function (v) {
      return typeof v === "object" && "today" in v && "sunday" in v && "redLetter" in v && "daily" in v && "about" in v ? {_: {}
                                                                                                                          ...
                                                                                                                          v.about)} : _U.badPort("an object with fields `today`, `sunday`, `redLetter`, `daily`, `about`",
      v);
   });
   ...
   var Model = F5(function (a,b,c,d,e) {
      return {today: a,sunday: b,redLetter: c,daily: d,about: e};
   });
